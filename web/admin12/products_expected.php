...
?>
                ...
                <td class="dataTableContent" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_CATEGORIES, 'pID=' . $products['products_id'] . '&amp;action=new_product') . '">' . tep_image(DIR_WS_ICONS . 'edit.png', IMAGE_EDIT) . '</a>';?>&nbsp;&nbsp;<?php if (isset($pInfo) && is_object($pInfo) && ($products['products_id'] == $pInfo->products_id)) { echo tep_image(DIR_WS_IMAGES . 'icon_arrow_right.png'); } else { echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_EXPECTED, 'page=' . $_GET['page'] . '&pID=' . $products['products_id']) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.png', IMAGE_ICON_INFO) . '</a>'; } ?>&nbsp;</td>
              </tr>
<?php
  }
?>
...
<?php
  ...
  if (isset($pInfo) && is_object($pInfo)) {
    ...
    $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_CATEGORIES, 'pID=' . $pInfo->products_id . '&amp;action=new_product') . '">' . tep_image_button('button_edit.png', IMAGE_EDIT) . '</a>');
