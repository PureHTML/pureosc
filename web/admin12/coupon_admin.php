...
//            tep_db_perform(TABLE_COUPONS_DESCRIPTION, $sql_data_marray[$i], 'update', "coupon_id='" . $_GET['cid']."'");            
          ...
          $insert_id = tep_db_insert_id_old($query);
...
?>
                ...
                <td class="dataTableContent" align="right"><?php if ( (is_object($cInfo)) && ($cc_list['unique_id'] == $cInfo->unique_id) ) { echo tep_image(DIR_WS_IMAGES . 'icon_arrow_right.png'); } else { echo '<a href="' . tep_href_link(FILENAME_COUPON_ADMIN, 'page=' . $_GET['page'] . '&amp;cid=' . $cc_list['coupon_id']) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.png', IMAGE_ICON_INFO) . '</a>'; } ?>&nbsp;</td>
              </tr>
<?php
    }
?>
...
?>
                <table border="0" width="100%" cellpadding="0" cellspacing="2">
                  <tr>
                    <td><?php ?>&nbsp;</td>
                    <td align="right"><?php echo '<a href="' . tep_href_link(FILENAME_COUPON_ADMIN) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a> ' . tep_image_submit('button_send_mail.png', IMAGE_SEND_EMAIL); ?></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
...
?>
     <tr>
        <td align="left"><?php echo tep_image_submit('button_confirm.png',IMAGE_CONFIRM); ?></td>
        <td align="left"><?php echo tep_image_submit('button_back.png',IMAGE_BACK, 'name=back'); ?></td>
      </td>
      </tr>
...
?>
      <tr>
        <td align="left" class="main"><?php echo COUPON_AMOUNT . ' ' . $currencies->format(0); ?></td>
        <td align="left"><?php echo tep_draw_input_field('coupon_amount', $coupon_amount); ?></td>
        <td align="left" class="main"><?php echo COUPON_AMOUNT_HELP . ' ' . $currencies->format(0); ?></td>
      </tr>
      <tr>
...
?>
      <tr>
        <td align="left"><?php echo tep_image_submit('button_preview.png',IMAGE_PREVIEW); ?></td>
        <td align="left"><?php echo '&nbsp;&nbsp;<a href="' . tep_href_link('coupon_admin.php', ''); ?>"><?php echo tep_image_button('button_cancel.png', IMAGE_CANCEL); ?></a>
      </td>
      </tr>
      </td></table></form>
      </tr>
...
?></td>
                <td class="dataTableContent" align="right"><?php echo '<a href="'.tep_href_link('coupon_admin.php','action=email&amp;cid='.$cc_list['coupon_id'],'NONSSL').'">'.tep_image(DIR_WS_ICONS . 'mail.png',COUPON_BUTTON_EMAIL_VOUCHER).'</a>'; ?>&nbsp;&nbsp;
<?php echo '<a href="'.tep_href_link('coupon_admin.php','action=voucheredit&amp;cid='.$cc_list['coupon_id'],'NONSSL').'">'.tep_image(DIR_WS_ICONS . 'edit.png',COUPON_BUTTON_EDIT_VOUCHER).'</a>';?>&nbsp;&nbsp;
<?php echo '<a href="'.tep_href_link('coupon_admin.php','action=voucherdelete&amp;status=' . $status . (($_GET['page'] > 1) ? '&amp;page=' . $_GET['page']: '') . '&amp;cid='.$cc_list['coupon_id'],'NONSSL').'">'.tep_image(DIR_WS_ICONS . 'delete.png',COUPON_BUTTON_DELETE_VOUCHER).'</a>';?>&nbsp;&nbsp;
<?php echo '<a href="'.tep_href_link('coupon_admin.php','action=voucherreport&amp;cid='.$cc_list['coupon_id'],'NONSSL').'">'.tep_image(DIR_WS_ICONS . 'report.png',COUPON_BUTTON_VOUCHER_REPORT).'</a>';?>&nbsp;&nbsp;<?php if ( (is_object($cInfo)) && ($cc_list['coupon_id'] == $cInfo->coupon_id) ) { echo tep_image(DIR_WS_IMAGES . 'icon_arrow_right.png'); } else { echo '<a href="' . tep_href_link(FILENAME_COUPON_ADMIN, 'page=' . $_GET['page'] . '&amp;cid=' . $cc_list['coupon_id']) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.png', IMAGE_ICON_INFO) . '</a>'; } ?>&nbsp;</td>
              </tr>
<?php
      $redeem_date = '';
...
?>
          <tr>
            <td colspan="5"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              ...
              <tr>
                <td align="right" colspan="2" class="smallText"><?php echo '<a href="' . tep_href_link('coupon_admin.php', 'page=' . $_GET['page'] . '&amp;cid=' . $cInfo->coupon_id . '&amp;action=new') . '">' . tep_image_button('button_insert.png', IMAGE_INSERT) . '</a>'; ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
    ...
    default:
      ...
      if ($_GET['action'] == 'voucherdelete') {
        $contents[] = array('text'=> TEXT_CONFIRM_DELETE . '</br></br>' . 
                '<a href="'.tep_href_link('coupon_admin.php','action=confirmdelete&amp;status=' . $status . (($_GET['page'] > 1) ? '&amp;page=' . $_GET['page']: '') . '&amp;cid='.$_GET['cid'],'NONSSL').'">'.tep_image_button('button_confirm.png',IMAGE_CONFIRM).'</a>' .
                '<a href="'.tep_href_link('coupon_admin.php','cid='.$cInfo->coupon_id,'NONSSL').'">'.tep_image_button('button_cancel.png',IMAGE_CANCEL).'</a>'
                );
      } else {
        $prod_details = NONE;
        ...
        $contents[] = array('text'=>COUPON_NAME . '&nbsp;:&nbsp;' . $coupon_name['coupon_name'] . '<br />' .
                     ...
                     '<center><a href="'.tep_href_link('coupon_admin.php','action=email&amp;cid='.$cInfo->coupon_id,'NONSSL').'">'.tep_image_button('button_email.png',COUPON_BUTTON_EMAIL_VOUCHER).'</a>' .
                     '<a href="'.tep_href_link('coupon_admin.php','action=voucheredit&amp;cid='.$cInfo->coupon_id,'NONSSL').'">'.tep_image_button('button_edit.png',COUPON_BUTTON_EDIT_VOUCHER).'</a>' .
                     '<a href="'.tep_href_link('coupon_admin.php','action=voucherdelete&amp;status=' . $status . (($_GET['page'] > 1) ? '&amp;page=' . $_GET['page']: '') . '&amp;cid='.$cInfo->coupon_id,'NONSSL').'">'.tep_image_button('button_delete.png',COUPON_BUTTON_DELETE_VOUCHER).'</a>' .
                     '<br /><a href="'.tep_href_link('coupon_admin.php','action=voucherreport&amp;cid='.$cInfo->coupon_id,'NONSSL').'">'.tep_image_button('button_report.png',COUPON_BUTTON_VOUCHER_REPORT).'</a></center>');
        }
        break;
      }
?>                       
