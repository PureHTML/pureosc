...
<!-- body_text //-->
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td width="100%">
        <?php echo tep_draw_form('year', FILENAME_ORDERS_STATISTICS, '', 'get'); ?>
...
?>
      ...
      <tr>
       ...
       <tr>
        <td align="center">
          <?php
            echo tep_draw_form('goto', FILENAME_ORDERS_STATISTICS, '', 'get');
  ...
  if (function_exists('imagecreate') && ($dir_ok == true) && tep_not_null($store_extension)) {
    ...
    switch ($type) {
      case 'yearly':
        ...
        echo tep_image(DIR_WS_IMAGES . 'graphs/orders_yearly_' . $graph_type . '.' . $store_extension);
        break;
      case 'monthly':
        include(DIR_WS_INCLUDES . 'graphs/orders_monthly.php');
        echo tep_image(DIR_WS_IMAGES . 'graphs/orders_monthly_' . $graph_type . '.' . $store_extension);
        break;
      default:
      case 'daily':
        include(DIR_WS_INCLUDES . 'graphs/orders_daily.php');
        echo tep_image(DIR_WS_IMAGES . 'graphs/orders_daily_' . $graph_type . '.' . $store_extension);
        break;
    }
?>
          <table border="0" width="600" cellspacing="0" cellpadding="2" class="dataTableRow">
            <tr class="dataTableHeadingRow">
             ...
             <td class="dataTableHeadingContent" align="right">Products</td>
             <td class="dataTableHeadingContent" align="right">Orders</td>
             <td class="dataTableHeadingContent" align="right">Orders Total</td>
           </tr>
<?php
    ...
    if($stats[$i][0]!='0')
      echo '            <tr onmouseover="this.style.background=\'#ffffff\'"  onmouseout="this.style.background=\'none\'" >' . "\n" .
           ...
           '              <td class="dataTableContent" align="right">' . $currencies->display_price($orders_price[$i][0],0) . '</td>' . "\n" .
           '            </tr>' . "\n";

      $total_host += $stats[$i][1];
      $total_hit += $stats[$i][2];
      $total_order_price += $orders_price[$i][0];
    }
?>
           ...
           <tr class="dataTableHeadingRow">
             ...
             <td class="dataTableHeadingContent" align="right"><b><?php echo $currencies->display_price($total_order_price,0);?></b></td>
           </tr>
          </table>
<?php
  }
