...
<!-- body_text //-->
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td width="100%">
        <?php echo tep_draw_form('year', FILENAME_STORE_STATISTICS, '', 'get'); ?>
...
?>
      ...
      <tr>
        <td align="center">
          <?php
            echo tep_draw_form('goto', FILENAME_STORE_STATISTICS, '', 'get');
...
<?php
  if (function_exists('imagecreate') && ($dir_ok == true) && tep_not_null($store_extension)) {
    ...
    switch ($type) {
      case 'yearly':
        include(DIR_WS_INCLUDES . 'graphs/store_yearly.php');
        echo tep_image(DIR_WS_IMAGES . 'graphs/store_yearly_' . $graph_type . '.' . $store_extension);
        break;
      case 'monthly':
        include(DIR_WS_INCLUDES . 'graphs/store_monthly.php');
        echo tep_image(DIR_WS_IMAGES . 'graphs/store_monthly_' . $graph_type . '.' . $store_extension);
        break;
      default:
      case 'daily':
        include(DIR_WS_INCLUDES . 'graphs/store_daily.php');
        echo tep_image(DIR_WS_IMAGES . 'graphs/store_daily_' . $graph_type . '.' . $store_extension);
        break;
    }
?>
          <table border="0" width="600" cellspacing="0" cellpadding="2" class="dataTableRow">
            <tr class="dataTableHeadingRow">
             ...
             <td class="dataTableHeadingContent" align="right">Hit</td>
             <td class="dataTableHeadingContent" align="right">Host</td>
           </tr>
<?php
    $total_host = 0;
    $total_hit = 0;
