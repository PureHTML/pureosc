...
?>
          <tr>
           ...
           <?php if (FCK_EDITOR == 'true') { ?>
                <td class="main"><?php echo tep_draw_fckeditor('topics_description[' . $languages[$i]['id'] . ']',(isset($topics_description[$languages[$i]['id']]) ? $topics_description[$languages[$i]['id']] : tep_get_topic_description($tInfo->topics_id, $languages[$i]['id']))); ?></td>
           <?php } else { ?>
          ...
          <tr>
            ...
            <td><table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="main" valign="top"><?php echo tep_image(DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']); ?>&nbsp;</td>
           <?php if (FCK_EDITOR == 'true') { ?>
                <td class="main"><?php echo tep_draw_fckeditor('articles_description[' . $languages[$i]['id'] . ']',(isset($articles_description[$languages[$i]['id']]) ? $articles_description[$languages[$i]['id']] : tep_get_articles_description($aInfo->articles_id, $languages[$i]['id']))); ?></td>
           <?php } else { ?>
