...
// START - Admin Notes
  define('TABLE_ADMIN_NOTES', DB_PREFIX . 'admin_notes');
  define('TABLE_ADMIN_NOTES_TYPE', DB_PREFIX . 'admin_notes_type');
// END - Admin Notes

//Admin begin
  define('TABLE_ADMIN', DB_PREFIX . 'admin');
  define('TABLE_ADMIN_FILES', DB_PREFIX . 'admin_files');
  define('TABLE_ADMIN_GROUPS', DB_PREFIX . 'admin_groups');
//Admin end
...
// END JUST SPIFFY Category Descriptions
  ...
  //TotalB2B end
    ...
    define('TABLE_SEO_GOOGLE', DB_PREFIX . 'seo_google');
    define('TABLE_SEO_MSN', DB_PREFIX . 'seo_msn');
    define('TABLE_SEO_YAHOO', DB_PREFIX . 'seo_yahoo');
