...
/*
  ...
  Changed by: Carlos Frederico Costa - 17/Jan/2007
*/ 
...
function get_yahoo_links($domain) {
 ...
 if ($fp) {
  ...
  function GetSearchURL($searchurl)
  {
  ...
  function PageLink ($name) { // same page link
   global $request_type;

   $link = ($request_type == 'SSL') ? HTTPS_SERVER : HTTP_SERVER;
