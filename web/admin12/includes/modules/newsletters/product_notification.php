...
//--></script>';
    ...
    function confirm() {
      ...
      $confirm_string .= '<a href="' . tep_href_link(FILENAME_NEWSLETTERS, 'page=' . $_GET['page'] . '&amp;nID=' . $_GET['nID'] . '&amp;action=send') . '">' . tep_image_button('button_back.png', IMAGE_BACK) . '</a> <a href="' . tep_href_link(FILENAME_NEWSLETTERS, 'page=' . $_GET['page'] . '&amp;nID=' . $_GET['nID']) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a></td>' . "\n" .
                         '  </tr>' . "\n" .
                         '</table>';
