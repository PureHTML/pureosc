  ...
  class newsletter {
    ...
    function confirm() {
      ...
      $confirm_string = '<table border="0" cellspacing="0" cellpadding="2">' . "\n" .
                        ...
                        '  </tr>' . "\n" .
                        '  <tr>' . "\n" .
                        '    <td align="right"><a href="' . tep_href_link(FILENAME_NEWSLETTERS, 'page=' . $_GET['page'] . '&amp;nID=' . $_GET['nID'] . '&amp;action=confirm_send') . '">' . tep_image_button('button_send.png', IMAGE_SEND) . '</a> <a href="' . tep_href_link(FILENAME_NEWSLETTERS, 'page=' . $_GET['page'] . '&amp;nID=' . $_GET['nID']) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a></td>' . "\n" .
                        '  </tr>' . "\n" .
                        '</table>';
