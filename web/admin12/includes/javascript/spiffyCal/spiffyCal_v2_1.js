...
img_Del.src= scImgPath +"btn_del_small.png";
img_Close.src= scImgPath +"btn_close_small.png";
...
function ctlSpiffyCalendarBox(strVarName, strFormName, strTextBoxName, strBtnName, strDefaultValue, intBtnMode) {
	...
	switch (intBtnMode) {
		case 0 :
			strBtnImg=strDefBtnImgPath+'btn_date_up.png';
			img_DateBtn_UP.src=strDefBtnImgPath+'btn_date_up.png';
			img_DateBtn_OVER.src=strDefBtnImgPath+'btn_date_over.png';
			img_DateBtn_DOWN.src=strDefBtnImgPath+'btn_date_down.png';
			img_DateBtn_DISABLED.src=strDefBtnImgPath+'btn_date_disabled.png';
			strBtnW = '18';
			strBtnH = '20';
			break;
		case 1 :
			strBtnImg=strDefBtnImgPath+'btn_date1_up.png';
			img_DateBtn_UP.src=strDefBtnImgPath+'btn_date1_up.png';
			img_DateBtn_OVER.src=strDefBtnImgPath+'btn_date1_over.png';
			img_DateBtn_DOWN.src=strDefBtnImgPath+'btn_date1_down.png';
			img_DateBtn_DISABLED.src=strDefBtnImgPath+'btn_date1_disabled.png';
			strBtnW = '22';
			strBtnH = '17';
			break;
		case 2 :
			strBtnImg=strDefBtnImgPath+'btn_date2_up.png';
			img_DateBtn_UP.src=strDefBtnImgPath+'btn_date2_up.png';
			img_DateBtn_OVER.src=strDefBtnImgPath+'btn_date2_over.png';
			img_DateBtn_DOWN.src=strDefBtnImgPath+'btn_date2_down.png';
			img_DateBtn_DISABLED.src=strDefBtnImgPath+'btn_date2_disabled.png';
			strBtnW = '34';
			strBtnH = '21';
			break;
	}
	...
	function makeCalendar(intWhatMonth,intWhatYear,bViewOnly) {
		...
		if (!(bViewOnly)) {
			...
			strOutput += '<\/SELECT>&nbsp;<a href="javascript:'+this.varName+'.scrollMonth(1);" class="cal-DayLink">&gt;</a>&nbsp;&nbsp;<a href="javascript:'+this.varName+'.hide();"><img name="calbtn2" src="'+strDefBtnImgPath+'btn_close_small.png" border="0" width="12" height="10"></a><\/td><\/tr><tr><td width="100%" align="center">';
		}
		else {
