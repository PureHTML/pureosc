...
define('TEXT_BANNERS_BANNER_NOTE', '<b>Note Banner:</b><ul><li>Usa un\'immagine o testo HTML per il Banner - non entrambi.</li><li>Un testo HTML &egrave; prioritario rispetto ad una immagine.</li></ul>');
...
define('TEXT_BANNERS_SCHEDULE_NOTE', '<b>Note Programma:</b><ul><li>Se un programma &egrave; gi&agrave; stato impostato, il banner si attiver&agrave; in quella data.</li><li>Tutti i Banner programmati saranno visualizzati come non attivi fino alla loro data di attivazione, durante la quale torneranno attivi.</li></ul>');
...
define('SUCCESS_BANNER_INSERTED', 'Operazione Riuscita: Il Banner &egrave; stato inserito.');
define('SUCCESS_BANNER_UPDATED', 'Operazione Riuscita:Il Banner &egrave; stato aggiornato.');
define('SUCCESS_BANNER_REMOVED', 'Operazione Riuscita: Il Banner &egrave; stato rimosso.');
define('SUCCESS_BANNER_STATUS_UPDATED', 'Operazione Riuscita: Lo Status del Banner &egrave; stato aggiornato.');
...
define('ERROR_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Errore: La Directory  non &egrave; scrivibile.');
...
define('ERROR_GRAPHS_DIRECTORY_NOT_WRITEABLE', 'Errore: La Directory graphs/ non &egrave; scrivibile.');
?>