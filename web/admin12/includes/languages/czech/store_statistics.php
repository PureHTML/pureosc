...
define('HEADING_TITLE', 'Store Statistics');
...
define('TEXT_DESCRIPTION','<font color="#0000ff">Blue</font> line display amount review  (Hit)<br />
                           <font color="#ff0000">Red</font> line display amount unique review (Host)');
