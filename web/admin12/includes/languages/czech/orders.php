...
define('EMAIL_TEXT_SUBJECT', 'Zpracovani objednavky');
define('EMAIL_TEXT_ORDER_NUMBER', 'Variabilní symbol / objednávka č:');
define('EMAIL_TEXT_INVOICE_URL', 'odkaz na fakturu:');
define('EMAIL_TEXT_DATE_ORDERED', 'Datum objednávky:');
define('EMAIL_TEXT_STATUS_UPDATE', 'Vase objednavka změnila status.' . "\n\n" . 'Nový status: %s' . "\n\n" . 'Máte-li. dotazy, odpovězte na tento e-mail' . "\n");
