...
define('TEXT_INFO_DELETE_INTRO', 'Remove <div><b>%s</b></div> from <div>Admin Members?</div>');
define('TEXT_INFO_DELETE_INTRO_NOT', 'You can not delete <div>%s group!</div>');
...
define('TEXT_INFO_ERROR', '<font color="#ff0000">Email address has already been used! Please try again.</font>');
...
define('TEXT_INFO_DELETE_GROUPS_INTRO', 'It\'s also will delete member of this group. Are you sure want to delete <div><b>%s</b> group?</div>');
...
define('TEXT_INFO_GROUPS_NAME_FALSE', '<font color="#ff0000"><b>ERROR:</b> At least the group name must have more than 5 character!</font>');
define('TEXT_INFO_GROUPS_NAME_USED', '<font color="#ff0000"><b>ERROR:</b> Group name has already been used!</font>');
