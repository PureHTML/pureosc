...
define('TEXT_INFO_DELETE_FILE_INTRO', 'Remove <font color="#ff0000"><b>%s</b></font> from <b>%s</b> box? ');
define('TEXT_INFO_NEW_FILE_INTRO', 'Check the <font color="#ff0000"><b>left menu</b></font> to make sure you store the right files.');
