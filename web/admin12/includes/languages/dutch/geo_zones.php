...
define('TEXT_INFO_EDIT_ZONE_INTRO', 'Gelieve de nodige wijzigingen te maken');
...
define('TEXT_INFO_NEW_SUB_ZONE_INTRO', 'Gelieve de nieuwe Sub Zone informatie in te geven');

define('TEXT_INFO_HEADING_EDIT_SUB_ZONE', 'Wijzig Sub Zone');
define('TEXT_INFO_EDIT_SUB_ZONE_INTRO', 'Gelieve de nodige wijzigingen te maken');
