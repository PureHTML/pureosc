...
define('HEADING_TITLE', 'Products Statistics');
...
define('TEXT_DESCRIPTION','<font color="#0000ff">Blue</font> line display amount review  products (Viewed)<br />
                           <font color="#ff0000">Red</font> line display amount purchased products (Purchased)');
