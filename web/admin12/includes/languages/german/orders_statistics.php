...
define('HEADING_TITLE', 'Orders Statistics');
...
define('TEXT_DESCRIPTION','<font color="#0000ff">Blue</font> line display amount purchased products (Porducts)<br />
                           <font color="#ff0000">Red</font> line display amount make orders (Orders)');
