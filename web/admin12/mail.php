...
?>
          <tr>
            <td><?php echo tep_draw_form('mail', FILENAME_MAIL, 'action=send_email_to_user'); ?><table border="0" width="100%" cellpadding="0" cellspacing="2">
              <tr>
...
?>
          <tr>
            <td><?php echo tep_draw_form('mail', FILENAME_MAIL, 'action=preview'); ?><table border="0" cellpadding="0" cellspacing="2">
              <tr>
