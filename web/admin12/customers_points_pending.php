...
?>
                ...
                <td class="dataTableContent">&nbsp;&nbsp;&nbsp;<?php echo strip_tags($pending_points['order_total']); ?></td>
                ...
                <td class="dataTableContent">&nbsp;&nbsp;&nbsp;<?php echo $pending_points['orders_status_name']; ?></td>
...
?>
                  <tr>
                    <td align="right" colspan="2"><?php echo '<a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING) . '">' . tep_image_button('button_reset.png', IMAGE_RESET) . '</a>'; ?></td>
                  </tr>
<?php
    }
?>
...
<?php
  ...
  switch ($action) {
    case 'confirm':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_confirm_points.png', BUTTON_TEXT_CONFIRM_PENDING_POINTS) . ' <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');
      break;
    case 'cancel':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_cancel_points.png', BUTTON_TEXT_CANCEL_PENDING_POINTS) . ' <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');
      break;
    case 'adjust':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_adjust_points.png', BUTTON_TEXT_ADJUST_POINTS) . ' <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');
      break;
    case 'rollback':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_rollback_points.png', BUTTON_TEXT_ROLL_POINTS) . ' <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');
      break;
    case 'delete':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_delete.png', BUTTON_TEXT_REMOVE_RECORD) . ' <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');
      break;
    ...
    default:
      if (isset($uInfo) && is_object($uInfo)) {
		...
		if ($uInfo->points_status == 1) {
		  $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=confirm') . '">' . tep_image_button('button_confirm_points.png', BUTTON_TEXT_CONFIRM_PENDING_POINTS) . '</a> <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=cancel') . '">' . tep_image_button('button_cancel_points.png', BUTTON_TEXT_CANCEL_PENDING_POINTS) . '</a> <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=adjust') . '">' . tep_image_button('button_adjust_points.png', BUTTON_TEXT_ADJUST_POINTS) . '</a> <a href="' . tep_href_link(FILENAME_MAIL, 'selected_box=tools&amp;customer=' . $uInfo->customers_email_address) . '">' . tep_image_button('button_email.png', IMAGE_EMAIL) . '</a> <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=delete') . '">' . tep_image_button('button_delete.png', BUTTON_TEXT_REMOVE_RECORD) . '</a>');
		}
		if ($uInfo->points_status == 2) {
		  $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('action')) . 'uID=' . $uInfo->unique_id . '&amp;action=rollback') . '">' . tep_image_button('button_rollback_points.png', BUTTON_TEXT_ROLL_POINTS) . '</a> <a href="' . tep_href_link(FILENAME_MAIL, 'selected_box=tools&amp;customer=' . $uInfo->customers_email_address) . '">' . tep_image_button('button_email.png', IMAGE_EMAIL) . '</a> <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=delete') . '">' . tep_image_button('button_delete.png', BUTTON_TEXT_REMOVE_RECORD) . '</a>');
		}
		if ($uInfo->points_status == 3) {
		  $contents[] = array('text' => '<a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=confirm') . '">' . tep_image_button('button_confirm_points.png', BUTTON_TEXT_CONFIRM_PENDING_POINTS) . '</a> <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=adjust') . '">' . tep_image_button('button_adjust_points.png', BUTTON_TEXT_ADJUST_POINTS) . '</a> <a href="' . tep_href_link(FILENAME_ORDERS . '?oID=' . $uInfo->orders_id . '&amp;action=edit') . '">' . tep_image_button('button_details.png', IMAGE_DETAILS) . '</a> <a href="' . tep_href_link(FILENAME_MAIL, 'selected_box=tools&amp;customer=' . $uInfo->customers_email_address) . '">' . tep_image_button('button_email.png', IMAGE_EMAIL) . '</a> <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=delete') . '">' . tep_image_button('button_delete.png', BUTTON_TEXT_REMOVE_RECORD) . '</a>');
		}
		if ($uInfo->points_status == 4) {
		  $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_ORDERS . '?oID=' . $uInfo->orders_id . '&amp;action=edit') . '">' . tep_image_button('button_details.png', IMAGE_DETAILS) . '</a> <a href="' . tep_href_link(FILENAME_MAIL, 'selected_box=tools&amp;customer=' . $uInfo->customers_email_address) . '">' . tep_image_button('button_email.png', IMAGE_EMAIL) . '</a> <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=delete') . '">' . tep_image_button('button_delete.png', BUTTON_TEXT_REMOVE_RECORD) . '</a>');
		}
