...
?>
                  ...
                  <tr>
                    <td class="main" align="right" colspan="3"><br /><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_option&amp;option_id=' . $_GET['option_id'] . '&amp;' . $page_info, 'NONSSL') . '">'; ?><?php echo tep_image_button('button_delete.png', ' delete '); ?></a>&nbsp;&nbsp;&nbsp;<?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, $page_info, 'NONSSL') . '">'; ?><?php echo tep_image_button('button_cancel.png', ' cancel '); ?></a>&nbsp;</td>
                  </tr>
<?php
    }
?>
...
?>
            ...
            <td align="center" class="smallText">&nbsp;<b><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_attribute&amp;attribute_id=' . $_GET['attribute_id'] . '&amp;' . $page_info) . '">'; ?><?php echo tep_image_button('button_confirm.png', IMAGE_CONFIRM); ?></a>&nbsp;&nbsp;<?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, $page_info, 'NONSSL') . '">'; ?><?php echo tep_image_button('button_cancel.png', IMAGE_CANCEL); ?></a>&nbsp;</b></td>
<?php
    } else {
?>
            ...
            <td align="center" class="smallText">&nbsp;<?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=update_attribute&amp;attribute_id=' . $attributes_values['products_attributes_id'] . '&amp;' . $page_info, 'NONSSL') . '">'; ?><?php echo tep_image_button('button_edit.png', IMAGE_UPDATE); ?></a>&nbsp;&nbsp;<?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_product_attribute&amp;attribute_id=' . $attributes_values['products_attributes_id'] . '&amp;' . $page_info, 'NONSSL') , '">'; ?><?php echo tep_image_button('button_delete.png', IMAGE_DELETE); ?></a>&nbsp;</td>
<?php
    }
