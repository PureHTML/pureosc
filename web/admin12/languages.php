...
?>
                ...
                <td class="dataTableContent" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_LANGUAGES, 'page=' . $_GET['page'] . '&amp;lID=' . $languages['languages_id'] . '&amp;action=edit') . '">' . tep_image(DIR_WS_ICONS . 'edit.png', IMAGE_EDIT) . '</a>';?>&nbsp;&nbsp; <?php echo '<a href="' . tep_href_link(FILENAME_LANGUAGES, 'page=' . $_GET['page'] . '&amp;lID=' . $languages['languages_id'] . '&amp;action=delete') . '">' . tep_image(DIR_WS_ICONS . 'delete.png', IMAGE_DELETE) . '</a>';?>&nbsp;&nbsp; <?php echo '<a href="' . tep_href_link(FILENAME_DEFINE_LANGUAGE, 'lngdir=' . $languages['directory'] ) . '">' . tep_image(DIR_WS_ICONS . 'details.png', IMAGE_DETAILS) . '</a>';?>&nbsp;&nbsp;<?php if (isset($lInfo) && is_object($lInfo) && ($languages['languages_id'] == $lInfo->languages_id)) { echo tep_image(DIR_WS_IMAGES . 'icon_arrow_right.png'); } else { echo '<a href="' . tep_href_link(FILENAME_LANGUAGES, 'page=' . $_GET['page'] . '&amp;lID=' . $languages['languages_id']) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.png', IMAGE_ICON_INFO) . '</a>'; } ?>&nbsp;</td>
              </tr>
<?php
  }
?>
