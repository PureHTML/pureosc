<?php
/*
  $Id: customers_points_referral.php, v 2.00 2006/JULY/07 11:05:21 dsa_ Exp $
   ...
   switch ($viewedSort) {
    ...
    while ($pending_points = tep_db_fetch_array($pending_points_query)) {
	 ...
	 if ($pending_points['points_type'] == 'RF') {
	   ...
	   $link = '<a href="' . tep_href_link(FILENAME_ORDERS . '?oID=' . $pending_points['orders_id'] . '&amp;action=edit') . '">' . tep_image(DIR_WS_ICONS . 'preview.png', ICON_PREVIEW_EDIT) . '</a>&nbsp;';
     }
	 ...
	 if ($pending_points['points_type'] == 'RV') {
	   ...
	   $link = '<a href="' . tep_href_link(FILENAME_REVIEWS, 'page=' . $_GET['page'] . '&amp;rID=' . $reviews['reviews_id'] . '&amp;action=edit') . '">' . tep_image(DIR_WS_ICONS . 'preview.png', ICON_REVIEWS_EDIT) . '</a>&nbsp;';
     }
...
?>
                ...
                <td class="dataTableContent" align="right"><?php if (isset($uInfo) && is_object($uInfo) && ($pending_points['unique_id'] == $uInfo->unique_id)) { echo tep_image(DIR_WS_IMAGES . 'icon_arrow_right.png', ''); } else { echo '<a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID')) . 'uID=' . $pending_points['unique_id']) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.png', IMAGE_ICON_INFO) . '</a>'; } ?>&nbsp;</td>
              </tr>
<?php
    }
?>
...
<!-- Yes, you may remove this advertising clause. //-->
                  <tr>
                    <td class="smallText" align="center"><br /><br /><?php echo TEXT_LINK_CREDIT . '<br /><br />POINTS AND REWARDS MODULE V' . MOD_VER; ?>&nbsp;&nbsp;</td>
                  </tr>
<!-- advertising_eof //-->
<?php
    if (isset($_GET['search']) && tep_not_null($_GET['search'])) {
?>
                  <tr>
                    <td align="right" colspan="2"><?php echo '<a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL) . '">' . tep_image_button('button_reset.png', IMAGE_RESET) . '</a>'; ?></td>
                  </tr>
<?php
    }
?>
...
<?php
  ...
  switch ($action) {
    case 'confirm':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_confirm_points.png', BUTTON_TEXT_CONFIRM_PENDING_POINTS) . ' <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');
      break;
    case 'cancel':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_cancel_points.png', BUTTON_TEXT_CANCEL_PENDING_POINTS) . ' <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');
      break;
    case 'adjust':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_adjust_points.png', BUTTON_TEXT_ADJUST_POINTS) . ' <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');
      break;
    case 'rollback':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_rollback_points.png', BUTTON_TEXT_ROLL_POINTS) . ' <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');
      break;
    case 'delete':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_delete.png', BUTTON_TEXT_REMOVE_RECORD) . ' <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');
      break;
    ...
    default:
      if (isset($uInfo) && is_object($uInfo)) {
		...
		if ($uInfo->points_status == 1) {
		  $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=confirm') . '">' . tep_image_button('button_confirm_points.png', BUTTON_TEXT_CONFIRM_PENDING_POINTS) . '</a> <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=cancel') . '">' . tep_image_button('button_cancel_points.png', BUTTON_TEXT_CANCEL_PENDING_POINTS) . '</a> <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=adjust') . '">' . tep_image_button('button_adjust_points.png', BUTTON_TEXT_ADJUST_POINTS) . '</a> <a href="' . tep_href_link(FILENAME_MAIL, 'selected_box=tools&amp;customer=' . $uInfo->customers_email_address) . '">' . tep_image_button('button_email.png', IMAGE_EMAIL) . '</a> <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=delete') . '">' . tep_image_button('button_delete.png', BUTTON_TEXT_REMOVE_RECORD) . '</a>');
        }
		if ($uInfo->points_status == 2) {
		  $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('action')) . 'uID=' . $uInfo->unique_id . '&amp;action=rollback') . '">' . tep_image_button('button_rollback_points.png', BUTTON_TEXT_ROLL_POINTS) . '</a> <a href="' . tep_href_link(FILENAME_MAIL, 'selected_box=tools&amp;customer=' . $uInfo->customers_email_address) . '">' . tep_image_button('button_email.png', IMAGE_EMAIL) . '</a> <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=delete') . '">' . tep_image_button('button_delete.png', BUTTON_TEXT_REMOVE_RECORD) . '</a>');
		}
		if ($uInfo->points_status == 3) {
		  $contents[] = array('text' => '<a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=confirm') . '">' . tep_image_button('button_confirm_points.png', BUTTON_TEXT_CONFIRM_PENDING_POINTS) . '</a> <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=adjust') . '">' . tep_image_button('button_adjust_points.png', BUTTON_TEXT_ADJUST_POINTS) . '</a> <a href="' . tep_href_link(FILENAME_ORDERS . '?oID=' . $uInfo->orders_id . '&amp;action=edit') . '">' . tep_image_button('button_details.png', IMAGE_DETAILS) . '</a> <a href="' . tep_href_link(FILENAME_MAIL, 'selected_box=tools&amp;customer=' . $uInfo->customers_email_address) . '">' . tep_image_button('button_email.png', IMAGE_EMAIL) . '</a> <a href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_REFERRAL, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&amp;action=delete') . '">' . tep_image_button('button_delete.png', BUTTON_TEXT_REMOVE_RECORD) . '</a>');
		}
		...
		if ($uInfo->points_type == 'RF') {
		  $order_link = '<a href="' . tep_href_link(FILENAME_ORDERS, tep_get_all_get_params(array('oID', 'action')) . 'oID=' . $uInfo->orders_id . '&amp;action=edit') . '">' . tep_image(DIR_WS_ICONS . 'preview.png', ICON_PREVIEW_EDIT) . '</a>&nbsp;';
		...
		if ($uInfo->points_type == 'RV') {
		  $review_link = '<a href="' . tep_href_link(FILENAME_REVIEWS, 'page=' . $_GET['page'] . '&amp;rID=' . $uInfo->reviews_id . '&amp;action=edit') . '">' . tep_image(DIR_WS_ICONS . 'preview.png', ICON_REVIEWS_EDIT) . '</a>&nbsp;';
