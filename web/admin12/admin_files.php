<?php
/*
  $Id: admin_files.php,v update agosto 2007
              ...
              <tr>
                <td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td class="smallText" valign="top" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_ADMIN_FILES, 'cID=' . $_GET['cPath']) . '">' . tep_image_button('button_back.png', IMAGE_BACK) . '</a>&nbsp;<a href="' . tep_href_link(FILENAME_ADMIN_FILES, 'cPath=' . $_GET['cPath'] . '&amp;action=store_file') . '">' . tep_image_button('button_admin_files.png', IMAGE_INSERT_FILE) . '</a>'; ?>&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
            </table>
                ...
                <td class="dataTableContent" align="center"><?php
                                               if ( (is_object($cInfo)) && ($_GET['cID'] == $boxes[$i]['admin_boxes_id'])) {
                                                 ...
                                                 if (substr($boxes[$i]['admin_boxes_id'], 0,1) == 'b') {
                                                   ...
                                                   echo tep_image(DIR_WS_IMAGES . 'icon_status_red_light.png', '', 10, 10) . '&nbsp;' . tep_image(DIR_WS_IMAGES . 'icon_status_green.png', '', 10, 10);
                                                 }
                                               }
                                             ?>
                </td>
