...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td class="pageHeading"><?php echo nl2br(STORE_NAME_ADDRESS); ?><br /><?=CISLO_UCTU?></td>
        <td class="pageHeading" align="left" valign="top"><?=INVOICE_HEADER ?>: <?= $oID; ?>
        <br /><span style="font-size:12px"><?=DATE_VYSTAVENI ?> <?=tep_date_short($order->info['date_purchased'])?>
        <br /><span style="font-size:12px"><?=DATE_USKUTECNENENI ?> <?=tep_date_short($order->info['date_purchased'])?>
        <br /><?=INVOICE_VARSYMBOL?>: <?=$oID ?></span></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          ...
          <tr>
            <td class="main"><?php echo tep_address_format($order->customer['format_id'], $order->billing, 1, '', '<br />');
            ?></td>
          </tr>
          <tr>
...
?>
  ...
  <tr>
    <td class="dataTableHeadingContent"><?= INVOICE_VYSTAVIL ?></td>
  </tr>
</table>
