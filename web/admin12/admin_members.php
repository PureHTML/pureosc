<?php
/*
  $Id: admin_members.php,v update agosto 2007
...
// Thomas Schittli: Start Bugfixes
        $admin_right_access = get_admin_right_access($_POST);
        $admin_cat_access   = get_admin_cat_access($_POST);
...
// Thomas Schittli: Start Bugfixes
  function get_admin_right_access($_POST) {
    ...
    return $admin_right_access;
  }

  function get_admin_cat_access($_POST) {
    $n = 0;
...
?>
              <tr class="dataTableRowBoxes">
                <td colspan=2 class="dataTableContent" valign="top" align="right"><?php if ($_GET['gPath'] != 1) { echo  '<a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'gID=' . $_GET['gPath']) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a> ' . tep_image_submit('button_save.png', IMAGE_SAVE); } else { echo tep_image_submit('button_back.png', IMAGE_BACK); } ?>&nbsp;</td>
              </tr>
            </table></form>
<?php
 } elseif ($_GET['gID']) {
...
?>
                ...
                <td class="dataTableContent" align="right"><?php if ( (is_object($gInfo)) && ($groups['admin_groups_id'] == $gInfo->admin_groups_id) ) { echo tep_image(DIR_WS_IMAGES . 'icon_arrow_right.png'); } else { echo '<a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'gID=' . $groups['admin_groups_id']) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.png', IMAGE_ICON_INFO) . '</a>'; } ?>&nbsp;</td>
              </tr>
<?php
    $count_groups++;
  } 
              ...
              <tr>
                <td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td class="smallText" valign="top" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS) . '">' . tep_image_button('button_back.png', IMAGE_BACK) . '</a> <a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'gID=' . $gInfo->admin_groups_id . '&amp;action=new_group') . '">' . tep_image_button('button_admin_group.png', IMAGE_NEW_GROUP) . '</a>'; ?>&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
            </table>
...
?>
                ...
                <td class="dataTableContent" align="right"><?php if ( (is_object($mInfo)) && ($admin['admin_id'] == $mInfo->admin_id) ) { echo tep_image(DIR_WS_IMAGES . 'icon_arrow_right.png'); } else { echo '<a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'page=' . $_GET['page'] . '&amp;mID=' . $admin['admin_id']) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.png', IMAGE_ICON_INFO) . '</a>'; } ?>&nbsp;</td>
              </tr>
<?php
  } 
?>
              <tr>
                <td colspan="5"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td class="smallText" valign="top" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'gID=groups') . '">' . tep_image_button('button_admin_groups.png', IMAGE_GROUPS) . '</a>'; echo ' <a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'page=' . $_GET['page'] . '&amp;mID=' . $mInfo->admin_id . '&amp;action=new_member') . '">' . tep_image_button('button_admin_member.png', IMAGE_NEW_MEMBER) . '</a>'; ?>&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
            </table>
...
// EOF: KategorienAdmin / OLISWISS
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_insert.png', IMAGE_INSERT, 'onclick="validateForm();return document.returnValue"') . ' <a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'page=' . $_GET['page'] . '&amp;mID=' . $_GET['mID']) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');
      break;
    case 'edit_member': 
      $heading[] = array('text' => '<b>' . TEXT_INFO_HEADING_NEW . '</b>');
...
// Thomas Schittli: Start Bugfixes
      ...
      $contents[] = array('text' => '<br />&nbsp;<b>' . TEXT_INFO_CATEGORIEACCESS . '</b><br />&nbsp;' . $all_categories);
// modify for error in primary ADMIN
...
// Thomas Schittli: Bugfixes: Button 'Save' and not 'Insert'
      $contents[] = array('align' => 'center', 'text' => '<br />' .
                          tep_image_submit('button_save.png', IMAGE_SAVE, 'onclick="validateForm();return document.returnValue"') .
                          ' <a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'page=' . $_GET['page'] . '&amp;mID=' . $_GET['mID']) . '">' .
    ...
    case 'del_member': 
      ...
      $contents[] = array('align' => 'center', 'text' => '<br /><a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'page=' . $_GET['page'] . '&amp;mID=' . $mInfo->admin_id) . '">' . tep_image_button('button_back.png', IMAGE_BACK) . '</a><br />&nbsp;');
      } else {
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_delete.png', IMAGE_DELETE) . ' <a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'page=' . $_GET['page'] . '&amp;mID=' . $_GET['mID']) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');    
      }
      break;
    case 'new_group':
...
// Thomas Schittli: Bugfixes: Button 'Save' and not 'Next'
      $contents[] = array('align' => 'center', 'text' => '<br /><a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'gID=' . $gInfo->admin_groups_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a> ' . tep_image_submit('button_save.png', IMAGE_SAVE) );
      break;
    case 'edit_group': 
      ...
      $contents[] = array('align' => 'center', 'text' => TEXT_INFO_EDIT_GROUPS_INTRO . '<br />&nbsp;<br />' . tep_draw_input_field('admin_groups_name', $gInfo->admin_groups_name)); 
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_save.png', IMAGE_SAVE) . ' <a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'gID=' . $gInfo->admin_groups_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');    
      break;
    case 'del_group': 
      ...
      if ($gInfo->admin_groups_id == 1) {
        ...
        $contents[] = array('align' => 'center', 'text' => '<br /><a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'gID=' . $_GET['gID']) . '">' . tep_image_button('button_back.png', IMAGE_BACK) . '</a><br />&nbsp;');
      } else {
        ...
        $contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_delete.png', IMAGE_DELETE) . ' <a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'gID=' . $_GET['gID']) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a><br />&nbsp;');    
      }
      break;
    case 'define_group':      
      ...
      if ($_GET['gPath'] == 1) {
        $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'gID=' . $_GET['gPath']) . '">' . tep_image_button('button_back.png', IMAGE_CANCEL) . '</a><br />');      
      }
      break;
    case 'show_group': 
      $heading[] = array('text' => '<b>' . TEXT_INFO_HEADING_EDIT_GROUP . '</b>');
      ...
      //$contents[] = array('align' => 'center', 'text' => '<br />' . tep_image_submit('button_insert.png', IMAGE_INSERT) . ' <a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'gID=' . $gInfo->admin_groups_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');    
      break;
    default:
      if (is_object($mInfo)) {
        ...
        if (strstr($str_cat_no,"ALL")== false){
          if ($str_cat_no == "") {
            ...
            while ($n < count($my_categories_array)) {
              $admin_category_query = tep_db_query("select categories_name from " . TABLE_CATEGORIES_DESCRIPTION . " where language_id=2 and categories_id=" . $my_categories_array[$n]) ;
              $admin_category = tep_db_fetch_array($admin_category_query);
              $my_categories .= $admin_category['categories_name'] . " (" . $my_categories_array[$n] . ")<br />&nbsp;";
              $n = $n + 1;
            }
          }
        } else {
...
// EOF: KategorienAdmin / OLISWISS
        ...
        $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'page=' . $_GET['page'] . '&amp;mID=' . $mInfo->admin_id . '&amp;action=edit_member') . '">' . tep_image_button('button_edit.png', IMAGE_EDIT) . '</a> <a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'page=' . $_GET['page'] . '&amp;mID=' . $mInfo->admin_id . '&amp;action=del_member') . '">' . tep_image_button('button_delete.png', IMAGE_DELETE) . '</a><br />&nbsp;');
...
// EOF: KategorienAdmin / OLISWISS
        ...
        $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'gPath=' . $gInfo->admin_groups_id . '&amp;action=define_group') . '">' . tep_image_button('button_admin_permission.png', IMAGE_FILE_PERMISSION) . '</a> <a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'gID=' . $gInfo->admin_groups_id . '&amp;action=edit_group') . '">' . tep_image_button('button_edit.png', IMAGE_EDIT) . '</a> <a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS, 'gID=' . $gInfo->admin_groups_id . '&amp;action=del_group') . '">' . tep_image_button('button_delete.png', IMAGE_DELETE) . '</a>');
