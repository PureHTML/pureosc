...
<?php
    ...
    echo '<table border="1" cellpadding="3" style="width: 600px; border: 0px; border-color: #000000;">' .
         '  <tr><td><a href="http://www.oscommerce.com"><img border="0" src="images/oscommerce.png" alt="' . PROJECT_VERSION . '" /></a><h1 class="p"> ' . PROJECT_VERSION . '</h1></td>' . 
         '  </tr>' .
         '</table>';
    echo $regs[1];
  } else {
