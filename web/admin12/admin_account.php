<?php
/*
  $Id: admin_account.php,v update agosto 2007
...
?>
                    <tr>
                      <td class="dataTableContent"><div><?php echo TEXT_INFO_FIRSTNAME; ?>&nbsp;&nbsp;&nbsp;</div></td>
                      <td class="dataTableContent"><?php echo tep_draw_input_field('admin_firstname', $myAccount['admin_firstname']); ?></td>
                    </tr>
                    <tr>
                      <td class="dataTableContent"><div><?php echo TEXT_INFO_LASTNAME; ?>&nbsp;&nbsp;&nbsp;</div></td>
                      <td class="dataTableContent"><?php echo tep_draw_input_field('admin_lastname', $myAccount['admin_lastname']); ?></td>
                    </tr>
                    <tr>
                      <td class="dataTableContent"><div><?php echo TEXT_INFO_EMAIL; ?>&nbsp;&nbsp;&nbsp;</div></td>
                      <td class="dataTableContent"><?php if ($_GET['error']) { echo tep_draw_input_field('admin_email_address', $myAccount['admin_email_address']) . ' <div>' . TEXT_INFO_ERROR . '</div>'; } else { echo tep_draw_input_field('admin_email_address', $myAccount['admin_email_address']); } ?></td>
                    </tr>
                    <tr>
                      <td class="dataTableContent"><div><?php echo TEXT_INFO_PASSWORD; ?>&nbsp;&nbsp;&nbsp;</div></td>
                      <td class="dataTableContent"><?php echo tep_draw_password_field('admin_password'); ?></td>
                    </tr>
                    <tr>
                      <td class="dataTableContent"><div><?php echo TEXT_INFO_PASSWORD_CONFIRM; ?>&nbsp;&nbsp;&nbsp;</div></td>
...
?>                        
                    <tr>
                      <td class="dataTableContent"><div><?php echo TEXT_INFO_FULLNAME; ?>&nbsp;&nbsp;&nbsp;</div></td>
                    ...
                    <tr class="dataTableRowSelected">
                      <td class="dataTableContent"><div><?php echo TEXT_INFO_GROUP; ?>&nbsp;&nbsp;&nbsp;</div></td>
                      <td class="dataTableContent"><?php echo $myAccount['admin_groups_name']; ?></td>
                    </tr>
                    <tr>
                      <td class="dataTableContent"><div><?php echo TEXT_INFO_CREATED; ?>&nbsp;&nbsp;&nbsp;</div></td>
                      <td class="dataTableContent"><?php echo $myAccount['admin_created']; ?></td>
                    </tr>
                    <tr>
                      <td class="dataTableContent"><div><?php echo TEXT_INFO_LOGNUM; ?>&nbsp;&nbsp;&nbsp;</div></td>
                      <td class="dataTableContent"><?php echo $myAccount['admin_lognum']; ?></td>
                    </tr>
                    <tr>
                      <td class="dataTableContent"><div><?php echo TEXT_INFO_LOGDATE; ?>&nbsp;&nbsp;&nbsp;</div></td>
...
?>                       
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="3"><tr><td class="smallText" valign="top"><?php echo TEXT_INFO_MODIFIED . $myAccount['admin_modified']; ?></td><td align="right"><?php if ($_GET['action'] == 'edit_process') { echo '<a href="' . tep_href_link(FILENAME_ADMIN_ACCOUNT) . '">' . tep_image_button('button_back.png', IMAGE_BACK) . '</a> '; if (tep_session_is_registered('confirm_account')) { echo tep_image_submit('button_save.png', IMAGE_SAVE, 'onclick="validateForm();return document.returnValue"'); } } elseif ($_GET['action'] == 'check_account') { echo '&nbsp;'; } else { echo tep_image_submit('button_edit.png', IMAGE_EDIT); } ?></td></table></td>
              </tr>              
            </table>
...
<?php
  ...
  switch ($_GET['action']) {
    case 'edit_process':
      ...
      //$contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_ADMIN_ACCOUNT) . '">' . tep_image_button('button_back.png', IMAGE_BACK) . '</a> ' . tep_image_submit('button_confirm.png', IMAGE_CONFIRM, 'onclick="validateForm();return document.returnValue"') . '<br />&nbsp;');
      break; 
    case 'check_account':
      ...
      $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_ADMIN_ACCOUNT) . '">' . tep_image_button('button_back.png', IMAGE_BACK) . '</a> ' . tep_image_submit('button_confirm.png', IMAGE_CONFIRM) . '<br />&nbsp;');
      break; 
    default:
      $heading[] = array('text' => '<b>&nbsp;' . TEXT_INFO_HEADING_DEFAULT . '</b>');
      
      $contents[] = array('text' => TEXT_INFO_INTRO_DEFAULT);
      //$contents[] = array('align' => 'center', 'text' => tep_image_submit('button_edit.png', IMAGE_EDIT) . '<br />&nbsp;');
