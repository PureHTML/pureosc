...
?>
  ...
  <tr><td class="main" colspan="2"><font color="#ff9933"><em><?php echo htmlspecialchars($comments['comment']); ?></em></font></td></tr>
...
<tr><td colspan="2" align="center" class="main">[ <a href="pollbooth.php?pollid=<? echo $pollid.'&op=vote';?>"><? echo _VOTING?></a> | <a href="pollbooth.php?op=list"><?echo _OTHERPOLLS?></a> ]</td></tr>
</table>
