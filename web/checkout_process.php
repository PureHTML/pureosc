...
// initialized for the email confirmation
  ...
  for ($i=0, $n=sizeof($order->products); $i<$n; $i++) {
       count_store_products_purchased(tep_get_prid($order->products[$i]['id']),$order->products[$i]['qty']);
...
//jsp:new:shop level disable mysql snooping security
...
// lets start with the email confirmation
  $email_order = STORE_NAME . "\n" . 
                 ...
                 EMAIL_TEXT_INVOICE_URL . ' ' . HTTP_SERVER . '/' .   FILENAME_ACCOUNT_HISTORY_INFO . '?order_id=' . $insert_id  . "\n" .
		 EMAIL_TEXT_WARNING_LOGIN . ":\n" .
		 HTTP_SERVER . '/' . FILENAME_LOGIN . "\n" .
...
//jsp:neposilame ale misto toho vzdy
//      $email_order .= $payment_class->email_footer . "\n\n";
    }
  }
  //shop2.0brain:new extra Footer
//	$email_order .= EMAIL_ORDER_EXTRA_FOOTER . "\n\n";
  //shop2.0brain:new posilame zakaznikovu adresu
    $email_order .= "\n\n Email zakaznika: \n\n" . $order->customer['email_address'] . "\n\n";
//jsp:paticka cislo uctu
    $email_order .= MODULE_PAYMENT_MONEYORDER_TEXT_EMAIL_FOOTER;
//shop2.0brain:stop: neposilame mail zakaznikovi
  tep_mail($order->customer['firstname'] . ' ' . $order->customer['lastname'], $order->customer['email_address'], EMAIL_TEXT_SUBJECT, $email_order, STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS);
       count_store_orders();
// send emails to other people
  if (SEND_EXTRA_ORDER_EMAILS_TO != '') {
    tep_mail('', SEND_EXTRA_ORDER_EMAILS_TO, EMAIL_TEXT_SUBJECT, $email_order, STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS);
//jsp posilame mail jeste na interni mail
if ($order->info['shipping_method'] == 'Osobní Odběr (Osobní Odběr)') tep_mail('', MAIL_INTERNI, EMAIL_TEXT_SUBJECT, $email_order, STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS);
  }
