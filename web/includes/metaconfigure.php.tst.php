...
//server
  define('META_BASE_URL','antitrust.linuxnetworks.cz');
  define('META_HTTP_SERVER', 'http://antitrust.linuxnetworks.cz'); 
  define('META_DIR_FS_DOCUMENT_ROOT', '/home/antitrust.cz/WWW/antitrust.linuxnetworks.cz/'); // where the pages are located on the server
//mysql
