...
define('HTML_PARAMS','dir="ltr" lang="en" xml:lang="en"');
...
define('BOX_NOTIFICATIONS_NOTIFY', 'Notify me of updates to <span class="b">%s</span>');
define('BOX_NOTIFICATIONS_NOTIFY_REMOVE', 'Do not notify me of updates to <span class="b">%s</span>');
...
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS', 'Displaying <span class="b">%d</span> to <span class="b">%d</span> (of <span class="b">%d</span> products)');
define('TEXT_DISPLAY_NUMBER_OF_ORDERS', 'Displaying <span class="b">%d</span> to <span class="b">%d</span> (of <span class="b">%d</span> orders)');
define('TEXT_DISPLAY_NUMBER_OF_REVIEWS', 'Displaying <span class="b">%d</span> to <span class="b">%d</span> (of <span class="b">%d</span> reviews)');
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW', 'Displaying <span class="b">%d</span> to <span class="b">%d</span> (of <span class="b">%d</span> new products)');
define('TEXT_DISPLAY_NUMBER_OF_SPECIALS', 'Displaying <span class="b">%d</span> to <span class="b">%d</span> (of <span class="b">%d</span> specials)');
...
define('TEXT_GREETING_PERSONAL', 'Welcome back <span class="greetUser">%s!</span> Would you like to see which <a href="%s"><span class="ColorSpan">new products</span></a> are available to purchase?');
define('TEXT_GREETING_PERSONAL_RELOGON', 'If you are not %s, please <a href="%s"><span class="ColorSpan">log yourself in</span></a> with your account information.');
define('TEXT_GREETING_GUEST', 'Welcome <span class="greetUser">Guest!</span> Would you like to <a href="%s"><span class="ColorSpan">log yourself in</span></a>? Or would you prefer to <a href="%s"><span class="ColorSpan">create an account</span></a>?');
...
define('WARNING_CONFIG_FILE_WRITEABLE_ADMIN', 'Warning: I am able to write to the configuration file: ' . dirname($_SERVER['SCRIPT_FILENAME']) . '/admin/includes/configure.php. This is a potential security risk - please set the right user permissions on this file.');
...
define('MENU_ABOUT_US','publisher');
