...
*/
  ...
  define('MODULE_PAYMENT_2CHECKOUT_TEXT_DESCRIPTION', '<img src="images/icon_popup.png" border="0">&nbsp;<a href="https://www.2checkout.com/2co/signup?affiliate=1255821" target="_blank" style="text-decoration: underline; font-weight: bold;">Visita la web de 2Checkout</a>&nbsp;<a href="javascript:toggleDivBlock(\'pm2checkoutInfo\');">(info)</a><span id="pm2checkoutInfo" style="display: none;"><br /><i>Con el uso del Link para usar 2Checkout osCommerce dar a cada Cliente nuevo un pequeno Bonus.</i></span><br /><br />Tarjeta de Cr&eacute;dito para Pruebas:<br /><br />Numero: 4111111111111111<br />Caducidad: Cualquiera');
