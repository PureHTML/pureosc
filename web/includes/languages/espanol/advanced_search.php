...
define('TEXT_SEARCH_HELP_LINK', '<span class="ColorSpan">Ayuda</span> [?]');
...
define('TEXT_SEARCH_HELP', 'El motor de b&uacute;squeda le permite hacer una b&uacute;squeda por palabras clave en el modelo, nombre y descripci&oacute;n del producto y en el nombre del fabricante.<br /><br />Cuando haga una busqueda por palabras o frases clave, puede separar estas con los operadores l&oacute;gicos AND y OR. Por ejemplo, puede hacer una busqueda por <span class="ColorSpan">microsoft AND raton</span>. Esta b&uacute;squeda dar&iacute;a como resultado los productos que contengan ambas palabras. Por el contrario, si teclea  <span class="ColorSpan">raton OR teclado</span>, conseguir&aacute; una lista de los productos que contengan las dos o solo una de las palabras. Si no se separan las palabras o frases clave con AND o con OR, la b&uacute;squeda se hara usando por defecto el operador logico AND.<br /><br />Puede realizar busquedas exactas de varias palabras encerrandolas entre comillas. Por ejemplo, si busca <span class="ColorSpan">"ordenador portatil"</span>, obtendr&aacute;s una lista de productos que tengan exactamente esa cadena en ellos.<br /><br />Se pueden usar paratensis para controlar el orden de las operaciones l&oacute;gicas. Por ejemplo, puede introducir <span class="ColorSpan">microsoft and (teclado or raton or "visual basic")</span>.');
define('TEXT_CLOSE_WINDOW', '<span class="ColorSpan">Cerrar Ventana</span> [x]');
