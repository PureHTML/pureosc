...
define('HTML_PARAMS','dir="ltr" lang="es" xml:lang="es"');
...
define('BOX_NOTIFICATIONS_NOTIFY', 'Notifiqueme de cambios a <span class="b">%s</span>');
define('BOX_NOTIFICATIONS_NOTIFY_REMOVE', 'No me notifique de cambios a <span class="b">%s</span>');
...
define('ENTRY_EMAIL_ADDRESS', 'Direcci&ograve;n de correo electr&ograve;nico:');
define('ENTRY_EMAIL_ADDRESS_ERROR', 'Su direcci&oacute;n de E-Mail debe tener al menos ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' letras.');
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', 'Su direcci&oacute;n de correo electr&ograve;nico no parece v&aacute;lida - por favor haga los cambios necesarios.');
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', 'Su direcci&oacute;n de correo electr&ograve;nico ya figura entre nuestros clientes - puede entrar a su cuenta con esta direcci&oacute;n o crear una cuenta nueva con una direcci&oacute;n diferente.');
...
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS', 'Viendo del <span class="b">%d</span> al <span class="b">%d</span> (de <span class="b">%d</span> productos)');
define('TEXT_DISPLAY_NUMBER_OF_ORDERS', 'Viendo del <span class="b">%d</span> al <span class="b">%d</span> (de <span class="b">%d</span> pedidos)');
define('TEXT_DISPLAY_NUMBER_OF_REVIEWS', 'Viendo del <span class="b">%d</span> al <span class="b">%d</span> (de <span class="b">%d</span> comentarios)');
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW', 'Viendo del <span class="b">%d</span> al <span class="b">%d</span> (de <span class="b">%d</span> productos nuevos)');
define('TEXT_DISPLAY_NUMBER_OF_SPECIALS', 'Viendo del<span class="b">%d</span> al <span class="b">%d</span> (de <span class="b">%d</span> ofertas)');
...
define('TEXT_GREETING_PERSONAL', 'Bienvenido de nuevo <span class="greetUser">%s!</span> &iquest;Le gustaria ver que <a href="%s"><span class="ColorSpan">nuevos productos</span></a> hay disponibles?');
define('TEXT_GREETING_PERSONAL_RELOGON', 'Si no es %s, por favor <a href="%s"><span class="ColorSpan">entre aqui</span></a> e introduzca sus datos.');
define('TEXT_GREETING_GUEST', 'Bienvenido <span class="greetUser">Invitado!</span> &iquest;Le gustaria <a href="%s"><span class="ColorSpan">entrar en su cuenta</span></a> o preferiria <a href="%s"><span class="ColorSpan">crear una cuenta nueva</span></a>?');
...
define('TEXT_REQUIRED', '<span class="ColorRed">Obligatorio</span>');

define('ERROR_TEP_MAIL', '<span class="ColorSpanRed2"><span class="b">TEP ERROR: No he podido enviar el email con el servidor SMTP especificado. Configura tu servidor SMTP en la secci&oacute;n adecuada del fichero php.ini.</span></span>');
...
define('WARNING_CONFIG_FILE_WRITEABLE_ADMIN', 'Advertencia: Puedo escribir en el fichero de configuraci&oacute;n: ' . dirname($_SERVER['SCRIPT_FILENAME']) . '/admin/includes/configure.php. En determinadas circunstancias esto puede suponer un riesgo - por favor corriga los permisos de este fichero.');
...
require(DIR_WS_LANGUAGES . 'add_ccgvdc_espanol.php');  // ICW CREDIT CLASS Gift Voucher Addittion
define('FILENAME_STATS_CREDITS', 'stats_credits.php');

//BOF ask a question
define('IMAGE_BUTTON_ASK_QUESTION','Envienos una question sobre este Producto');
define('BOX_HEADING_ASK_QUESTION','Question del Producto');
//EOF ask a question
