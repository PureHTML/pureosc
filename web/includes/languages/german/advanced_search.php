...
define('ERROR_INVALID_FROM_DATE', 'Unzul&auml;ssiges <span class="b">von</span> Datum');
define('ERROR_INVALID_TO_DATE', 'Unzul&auml;ssiges <span class="b">bis jetzt</span> Datum');
define('ERROR_TO_DATE_LESS_THAN_FROM_DATE', 'Das Datum <span class="b">von</span> muss gr&ouml;sser oder gleich dem <span class="b">bis jetzt</span> Datum sein');
define('ERROR_PRICE_FROM_MUST_BE_NUM', '<span class="b">Preis ab</span> muss eine Zahl sein');
define('ERROR_PRICE_TO_MUST_BE_NUM', '<span class="b">Preis bis</span> muss eine Zahl sein');
define('ERROR_PRICE_TO_LESS_THAN_PRICE_FROM', '<span class="b">Preis bis</span> muss gr&ouml;&szlig;er oder gleich <span class="b">Preis ab</span> sein.');
