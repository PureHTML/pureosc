...
define('TABLE_HEADING_RANDOM_PRODUCTS', 'Random Produkte');
...
if ( ($category_depth == 'products') || (isset($_GET['manufacturers_id'])) ) {
  ...
  define('TEXT_SHOW', '<span class="b">Darstellen:</span>');
  define('TEXT_BUY', '1 x \'');
...
$category = tep_db_fetch_array($category_query);
  define('HEADING_TITLE', 'Kategorien - ' . $category['categories_name']);
}
