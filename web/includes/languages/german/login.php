...
define('TEXT_PASSWORD_FORGOTTEN', 'Sie haben Ihr Passwort vergessen? Dann klicken Sie <span class="ColorSpan">hier</span>');

define('TEXT_LOGIN_ERROR', 'Fehler: Keine &Uuml;bereinstimmung der eingebenen eMail-Adresse und/oder dem Passwort.');
define('TEXT_LOGIN_ERROR_ACTIVATE', 'Account has not been Activated');
define('TEXT_VISITORS_CART', '<span class="ColorSpanRed">Achtung:</span> Ihre Besuchereingaben werden automatisch mit Ihrem Kundenkonto verbunden.');
define('TEXT_VISITORS_CART2', '[Mehr Information]');
?>
