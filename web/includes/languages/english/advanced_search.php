...
define('TEXT_SEARCH_HELP_LINK', '<span class="ColorSpan">Search Help</span> [?]');

define('TEXT_ALL_CATEGORIES', 'All Categories');
define('TEXT_ALL_MANUFACTURERS', 'All Manufacturers');

define('HEADING_SEARCH_HELP', 'Search Help');
define('TEXT_SEARCH_HELP', 'Keywords may be separated by AND and/or OR statements for greater control of the search results.<br /><br />For example, <span class="ColorSpan">Microsoft AND mouse</span> would generate a result set that contain both words. However, for <span class="ColorSpan">mouse OR keyboard</span>, the result set returned would contain both or either words.<br /><br />Exact matches can be searched for by enclosing keywords in double-quotes.<br /><br />For example, <span class="ColorSpan">"notebook computer"</span> would generate a result set which match the exact string.<br /><br />Brackets can be used for further control on the result set.<br /><br />For example, <span class="ColorSpan">Microsoft and (keyboard or mouse or "visual basic")</span>.');
define('TEXT_CLOSE_WINDOW', '<span class="ColorSpan">Close Window</span> [x]');
