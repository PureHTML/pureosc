...
define('EMAIL_TEXT_INVOICE_URL', 'Facture dataillee :');
...
define('EMAIL_TEXT_PAYMENT_METHOD', 'Methode de paiement');

define('EMAIL_SEPARATOR', '------------------------------------------------------');
define('TEXT_EMAIL_VIA', 'par l\'interm&eacute;diaire de');
?>