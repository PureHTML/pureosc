...
*/
  ...
  define('MODULE_PAYMENT_CC_TEXT_TITLE', 'Credit Card (Not For Production Use)');
  define('MODULE_PAYMENT_CC_TEXT_PUBLIC_TITLE', 'Credit Card');
  define('MODULE_PAYMENT_CC_TEXT_DESCRIPTION', 'This module stores the credit card number in the database without encryption and is not recommended for production use.<br /><br />Credit Card Test Info:<br /><br />CC#: 4111111111111111<br />Expiry: Any');
