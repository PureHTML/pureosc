...
define('TEXT_PRODUCT_POINTS', '<span class="b">Points Credit :</span> %s points Currently valued at %s');
define('TEXT_PRODUCT_NO_POINTS', '<span class="b">Points Credit :</span> No points awarded for discounted products.');
// Points/Rewards Module V2.00 EOF
define('TEXT_PRODUCT_NOT_FOUND', 'Product niet gevonden!');
define('TEXT_CURRENT_REVIEWS', 'Recente Reviews:');
define('TEXT_MORE_INFORMATION', 'Voor meer informatie, bezoek de <a href="%s"><span class="ColorSpan">website</span></a>.');
define('TEXT_DATE_ADDED', 'Dit product is op %s toegvoegd.');
define('TEXT_DATE_AVAILABLE', '<span class="ColorSpanRed">Dit product zal op %s op voorraad zijn.</span>');
define('TEXT_ALSO_PURCHASED_PRODUCTS', 'Klanten die dit product hebben gekocht hebben ook dit gekocht');
define('TEXT_PRODUCT_OPTIONS', 'Beschikbare Opties:');
define('TEXT_CLICK_TO_ENLARGE', 'Grotere Afbeelding');
define('TABLE_HEADING_QUANTITY', 'Aant.');

// multi image
define('TEXT_LIST_ENLARGE', 'List of images for : ');

// image for QTY
define('TEXT_IN_STOCK', 'Product in stock:');
...
define('ALL_REVIEWS', 'Click to view All Reviews');
?>