...
define('TEXT_ORIGIN_LOGIN', '<span class="ColorSpanRed"><span class="b">LET OP:</span></span> Als u al ingeschreven bent, log dan in bij de <a href="%s"><span class="ColorSpan">login pagina</span></a>.');
