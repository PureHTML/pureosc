...
define('FILENAME_CATALOG_LIST', 'catalog_products_list.php');
...
//*** <Reviews Mod>
  ...
  define('FILENAME_PRODUCT_REVIEW_EMAIL', 'admin/reviews.php'); // hai hai vuole ADMIN !
//*** </Reviews Mod>

  define('FILENAME_RANDOM_PRODUCTS', 'random_products.php');
...
//jsp:new:ankety
define('FILENAME_POLLBOTH','pollboth.php');
