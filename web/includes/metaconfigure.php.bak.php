...
//mysql
  define('META_DB_SERVER', '88.208.121.26'); // eg, localhost - should not be empty for productive servers
  define('META_DB_SERVER_PASSWORD', 'werwte88djhfsjk754gdsljjh');
  define('META_DB_DATABASE', 'dvere');
  define('META_DB_SERVER_USERNAME', 'dvere_eshop');
