          ...
          if ($GLOBALS[$class]->enabled) {
            ...
            for ($i=0; $i<$size; $i++) {
              $output_string .= $GLOBALS[$class]->output[$i]['title'] . '&nbsp;' . "\n" .
                                $GLOBALS[$class]->output[$i]['text'] . '<br />' . "\n" ;
            }
          }
        }
      }
...
//
    function credit_selection() {
      ...
      if (MODULE_ORDER_TOTAL_INSTALLED) {
        $header_string = '<span class="b">' . TABLE_HEADING_CREDIT . '</span>' . "\n";
        reset($this->modules);
        $output_string = '';
...
while (list(, $value) = each($this->modules)) {
          ...
          if ($GLOBALS[$class]->enabled && $GLOBALS[$class]->credit_class) {
            ...
            if ( ($use_credit_string !='' ) || ($selection_string != '') ) {
              $output_string = '<br /><span class="b">' . $GLOBALS[$class]->header . '</span><br />' . $use_credit_string ;
