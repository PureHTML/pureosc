	...
	class smtp{
        ...
        ***************************************/
		function smtp($params = array()){
			...
			// Force the auth variable to a boolean type so everything works correctly
			// This logic assumes the auth variable passed as a parameter is a string type
				...
				if ($this->debug AND !$result){
					        ...
					        preg_replace(array("/\r/", "/\n/", "/#EOL#/"),
					                     array("\\r", "\\n", "\n"), $this->log));
                                                ...
                                                // Unable to open the debug log file - terminate debug
                                                $this->debug = FALSE;
                                        }
                                }
				return $result;
        ...
        ***************************************/
		...
		function send_data($data){
			...
			if(is_resource($this->connection)){
				if ($this->debug){
                                	$this->log .= "send_data - " . $data.CRLF . "#EOL#";
                                }
