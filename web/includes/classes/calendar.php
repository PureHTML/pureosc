...
class Calendar
{
    ...
    */
	...
	$linkHeader = FILENAME_EVENTS_CALENDAR . '?_month=' . $month . '&_year=' . $year;
//jsp:orig SEO error	$linkHeader = tep_href_link(FILENAME_EVENTS_CALENDAR, "_month=$month&_year=$year");
 ...
 //       $s .= "&nbsp;";
    ...
    */
//jsp:todo:english
    var $dayNames = array(Ne,Po,Út,St,Čt,Pá,So);

    /*
        The labels to display for the months of the year. The first entry in this array
        represents January.
    */
//jsp:todo:english    var $monthNames = array(January,February,March,April,May,June,July,August,September,October,November,December);
