 ...
 */	
  function stock_href_link($page = '', $parameters = '', $connection = 'NONSSL', $add_session_id = false, $search_engine_safe = true) {
 ...
 */	
  ...
  { 
    ...
    return $return; //shop2.0brain:original code: return $current_page; 
  }  
