...
if (file_exists('templates/calendar/' . $Happyday . '/boxes.php')==1) {
    $Happy = $Happyday;
  } elseif ($HappyTemp == '01' ) {
    $Happy = '01_January';
  } elseif ($HappyTemp == '02') {
...
if (file_exists('templates/calendar/' . $Happy . '/boxes/boxes.php')==1){ 
  require ('templates/calendar/' . $Happy . '/boxes/boxes.php');
  } else { 
  require ('templates/calendar/00_Default/boxes/boxes.php');
}
?>