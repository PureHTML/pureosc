<?php
//english version shop2.0brain.com
// COLOR OPTION
$background = '#'. COLORE_SFONDO ;
$text_color = '#' . COLORE_TESTO;  
$border = '#' . COLORE_BORDO ;
$background_infobox = '#' . COLORE_RIPIENO;
$notification = '#f2fff7';
$orderEdit = '#70d250';
// TEXT OPTION
$custom_font1 = 'Verdana, Arial, sans-serif';
$custom_font2 = 'Arial';
//template settings
$template_position =  'width: 760px; position: relative; left: 50%; margin-left:  -380px;';
?>
...
#page {
<?php echo $template_position; ?>
}

BODY {
  font-family: <?php echo $custom_font1 ?>;
  font-size: 0.7em;
  text-align: center;
...
.productListing-odd, .productListing-even {
  background: <?php echo $background_infobox ?>;
  color: inherit;
}
...
SPAN.markProductOutOfStock {
  font-family: <?php echo $custom_font12 ?><?php echo $custom_font1 ?>;
  font-size: 0.75em;
  color: #c76170;
  font-weight: bold;
  background: inherit;
...
.checkoutBarCurrent { color: <?php echo $text_color ?>; background: inherit; }
...
.fedora-corner-tl { background: <?php echo $border ?> url("<?php echo bts_select(images, 'infobox/corner_left.png') ?>") no-repeat left top; }
.fedora-corner-tr { background: <?php echo $border ?> url("<?php echo bts_select(images, 'infobox/corner_right.png') ?>") no-repeat right top; }
