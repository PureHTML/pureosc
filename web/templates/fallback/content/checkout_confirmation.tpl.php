...
<?php
  if ($sendto != false) {
?>
  <?php echo '<h2 class="b">' . HEADING_DELIVERY_ADDRESS . '</h2><div class="InfoBoxContenent2MA">'
...
?>
  ...
  <?php echo '<h3 class="b">' . HEADING_BILLING_ADDRESS . '</h3> <a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL') . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?> <br />
