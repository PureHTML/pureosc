...
?>
  ...
  <?php echo tep_draw_input_field_label(ENTRY_FAX_NUMBER, false, 'fax', $account['customers_fax']) . '&nbsp;' . (tep_not_null(ENTRY_FAX_NUMBER_TEXT) ? '<span class="inputRequirement">' . ENTRY_FAX_NUMBER_TEXT . '</span>': ''); ?><br />
</div>
