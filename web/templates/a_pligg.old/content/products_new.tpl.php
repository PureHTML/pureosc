...
?>
  ...
  <?php echo '<br /><br /><a href="' . tep_href_link(FILENAME_PRODUCTS_NEW, tep_get_all_get_params(array('action')) . 'action=buy_now' 
             . SEPARATOR_LINK . 'products_id=' . $products_new['products_id']) . '">' . tep_image_button('button_in_cart.png', IMAGE_BUTTON_IN_CART) . '</a><br class="Clear" /><br />'; ?>
<br />
<?php
    }
  } else {
