...
<?php
    ...
    $boxLink = '<a class="BoxesInfoBoxHeadingCenterBoxRight" title="hotkey: [N]" href="' . tep_href_link(FILENAME_PRODUCTS_NEW) . '">'. BOX_HEADING_WHATS_NEW .'</a>';
    ...
    $boxContent = '<a accesskey="N" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product['products_id']) . '">' . '<span class="ie6balengo">' . tep_image(DIR_WS_IMAGES . $random_product['products_image'], $random_product['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) .'</span>'. $random_product['products_name'] .'</a><br />' . $whats_new_price . '<br />';
