<?php
/*
  shoop2.0brain:new cart show only if not empty
...
<?php
  ...
  $corner_left = 'square';
  $corner_right = 'square';
  $boxLink = '<a class="BoxesInfoBoxHeadingCenterBoxRight" title="Box_cart_grafic_Details" href="' . tep_href_link(FILENAME_SHOPPING_CART) . '"><font color="#8f8255">'.BOX_HEADING_SHOPPING_CART.'</font></a>';
