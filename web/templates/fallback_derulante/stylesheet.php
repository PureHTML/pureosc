...
#dropDownMenu ul li:hover ul, #dropDownMenu ul li li:hover ul, #dropDownMenu ul li li li:hover ul, #dropDownMenu ul li.sfhover ul, #dropDownMenu ul li li.sfhover ul, #dropDownMenu ul li li li.sfhover ul { /* listes imbriquees sous les items de listes survoles */
	left:90%;width:15em;
	display : block;
