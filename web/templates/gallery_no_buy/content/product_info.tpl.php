...
<?php
    ...
    $product_info_query = tep_db_query("select p.products_id, pd.products_name, pd.products_description, p.products_model, p.products_quantity, p.products_image, pd.products_url, p.products_price, p.products_length, p.products_width, p.products_height, p.products_codebar,
...
if (($product_info['products_length'] >= '0.01') && ($product_info['products_length'] != null) && 
   ...
   echo tep_image_2ma(bts_select(images, 'image_dimension.png')) . '<br />';
}
