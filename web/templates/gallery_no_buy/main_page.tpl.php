...
<div class="header">
  ...
  <span class="HeaderRight"><?php echo '<a href="' . tep_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">' . tep_image(bts_select(images, 'header_account.png'), HEADER_TITLE_MY_ACCOUNT) . '</a>&nbsp;'; ?>&nbsp;&nbsp;</span>
...
?><a href="<?php echo tep_href_link(FILENAME_ACCOUNT, '', 'SSL'); ?>" class="HeaderNavigationText"><?php echo HEADER_TITLE_MY_ACCOUNT; ?></a> &nbsp;&nbsp;</span>
<div class="Clear"> <br /> </div>
</div>
<!-- header_eof //-->
