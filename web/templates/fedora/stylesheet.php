...
.fedora-corner-tl, .fedora-corner-tr, .fedora-corner-bl, .fedora-corner-br {
	background-color: <?php echo $bordo_2 ?>;
	position: relative;
	width: 19px;
	height: 19px;
...
.fedora-corner-tl { background: <?php echo $bordo_2 ?> url("templates/fedora/images/corner-tl.png") no-repeat left top; }
.fedora-corner-tr { background: <?php echo $bordo_2 ?> url("templates/fedora/images/corner-tr.png") no-repeat right top; }
.fedora-corner-bl { background: <?php echo $bordo_2 ?> url("templates/fedora/images/corner-bl.png") no-repeat left bottom; }
.fedora-corner-br { background: <?php echo $bordo_2 ?> url("templates/fedora/images/corner-br.png") no-repeat right bottom; }
/*
.fedora-corner-tl { filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='templates/fedora/images/corner-tl.png',sizingMethod='scale'); }
.fedora-corner-tr { filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='templates/fedora/images/corner-tr.png',sizingMethod='scale'); }
.fedora-corner-br { filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='templates/fedora/images/corner-br.png',sizingMethod='scale'); }
.fedora-corner-bl { filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='templates/fedora/images/corner-bl.png',sizingMethod='scale'); }
*/
/* \*/
.fedora-corner-tl, .fedora-corner-tr, .fedora-corner-bl, .fedora-corner-br {
