...
// class constructor
    function tableBox($contents, $direct_output = false) {
      for ($i=0, $n=sizeof($contents); $i<$n; $i++) {
        ...
        if (isset($contents[$i][0]) && is_array($contents[$i][0])) {
          ...
          $tableBox_string .= '<div class="fedora-corner-tr">&nbsp;</div>
          ...
          $tableBox_string .= '><br /><br />' . $contents[$i]['text'] . '<div class="Clear"><br /></div><br /><br /></div>
                                                                                 <div class="fedora-corner-br">&nbsp;</div>
			                                                                     <div class="fedora-corner-bl">&nbsp;</div><br />' . "\n";
        }
  ...
  class infoBoxHeading extends tableBox {
    function infoBoxHeading($contents, $left_corner = true, $right_corner = true, $right_arrow = false) {
      ...
      $info_box_contents = array();
      $info_box_contents[] = array(array('params' => 'class="BoxesInfoBoxHeadingCenterBoxTitle"',
