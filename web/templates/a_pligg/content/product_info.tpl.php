...
$nodiscount = preg_replace('/[^0-9]/','',$currencies->display_price_nodiscount($product_info['products_price'], tep_get_tax_rate($product_info['products_tax_class_id'])));
$pricex = str_replace('<span>','', preg_replace('/[^0-9]/','',str_replace('.','', str_replace('Kč','',$products_price))));
//echo '$nodiscount:' . $nodiscount;
//echo 'pricexxx:'.$pricex.'konec';
if (intval($pricex) > 0 && intval($nodiscount) > intval($pricex)){
