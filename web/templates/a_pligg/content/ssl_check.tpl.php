...
<div class="AlignLeft">
  ...
  <?php new infoBox(array(array('text' => BOX_INFORMATION))); ?> 
  <br />
  <?php echo TEXT_INFORMATION; ?> 
  <br />
  <br />  
  <?php echo '<a href="' . tep_href_link(FILENAME_LOGIN) . '">' . tep_image_button('button_continue.png', IMAGE_BUTTON_CONTINUE) . '</a>'; ?>
</div>