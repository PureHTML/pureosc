...
<div style="position:absolute;left:280px;top:10px;width:200px;text-align:left">
<?
$contact_info_id = 12;
	$information_query = tep_db_query("SELECT information_title, information_description FROM " . TABLE_INFORMATION . " WHERE information_id='" . (int)$contact_info_id . "' AND language_id = '" . (int)$languages_id . "'");
