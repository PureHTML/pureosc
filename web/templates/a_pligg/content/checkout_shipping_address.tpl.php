...
?>
  ...
  <?php echo TEXT_SELECTED_SHIPPING_DESTINATION; ?> <br />
  <?php echo '<span class="b">' . TITLE_SHIPPING_ADDRESS . '</span><br />' . tep_image_2ma(bts_select(images, 'arrow_south_east.png')); ?>
  <?php echo tep_address_label($customer_id, $sendto, true, ' ', ' - '); ?> 
  </div> <br />
<?php
    if ($addresses_count > 1) {
?>
  <h2 class="b"><?php echo TABLE_HEADING_ADDRESS_BOOK_ENTRIES; ?></h2>
  <div class="InfoBoxContenent2MA">
  <?php echo TEXT_SELECT_OTHER_SHIPPING_DESTINATION; ?> <br />
    <div class="AlignLeft">
      <?php echo '<span class="b">' . TITLE_PLEASE_SELECT . '</span><br />' . tep_image_2ma(bts_select(images, 'arrow_east_south.png')); ?> <br />
<?php
      $radio_buttons = 0;
...
?>
      ...
      <span class="b"><?php echo tep_output_string_protected($addresses['firstname'] . ' ' . $addresses['lastname']); ?></span> &nbsp;
      </span>
...
?>
  <h2 class="b"> <?php echo TABLE_HEADING_NEW_SHIPPING_ADDRESS; ?> </h2> 
  <div class="InfoBoxContenent2MA">
  <?php echo TEXT_CREATE_NEW_SHIPPING_ADDRESS; ?> <br />
  <?php require(DIR_WS_MODULES . 'checkout_new_address.php'); ?> <br />
  </div> <br />
<?php
  }
?>
  <?php echo '<span class="b">' . TITLE_CONTINUE_CHECKOUT_PROCEDURE . ' ' . TEXT_CONTINUE_CHECKOUT_PROCEDURE . '</span><br /><br />'; ?> 
...
<div class="CinquantaR">
  <?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '">' . tep_image_button('button_back.png', IMAGE_BUTTON_BACK) . '</a>'; ?>
</div>
<?php
  }
?>
