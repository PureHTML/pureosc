...
// image for QTY END
          ...
          case 'PRODUCT_LIST_IMAGE':
            if (isset($_GET['manufacturers_id'])) {
              $lc_text = '<br /><a class="n" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'manufacturers_id=' . $_GET['manufacturers_id'] . SEPARATOR_LINK . 'products_id=' . $listing['products_id']) . '"><img src="' . 'images/' .  $listing['products_image'] .'"></a>';
            } else {
             if ($listing['products_image']=='') $listing['products_image'] = $image;
                 $lc_text = '<br />&nbsp;<a class="n" href="' . tep_href_link(FILENAME_PRODUCT_INFO, ($cPath ? 'cPath=' . $cPath . SEPARATOR_LINK : '') . 'products_id=' . $listing['products_id']) . '"><img src="' . 'images/' .  $listing['products_image'] .'"></a>&nbsp;';
            }
