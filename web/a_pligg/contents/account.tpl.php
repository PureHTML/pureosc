...
?>
  <div class="InfoBoxContenent2MA">
    ...
    <?php echo '<a href="account_history_info.php?order_id=' . $orders['orders_id'] . '">' . tep_image_button('small_view.png', SMALL_IMAGE_BUTTON_VIEW) . '</a>'; ?>
  </div><br />
<?php
    }
  }
...
?>
  <?php echo ' <a href="' . tep_href_link(FILENAME_GV_SEND, '', 'SSL') . '">' . CCGV_SENDVOUCHER . '</a>'; ?>
  <br />
  <?php echo ' <a href="' . tep_href_link(FILENAME_GV_FAQ, '', 'SSL') . '">' . CCGV_FAQ . '</a>'; ?>
</div> <br />
<?php 
}
?>
<!--// CCGV ADDED - END//-->
  ...
  <?php echo MY_ACCOUNT_TITLE; ?></h2>
    <div class="InfoBoxContenent2MA">
      <?php echo ' <a href="' . tep_href_link(FILENAME_ACCOUNT_EDIT, '', 'SSL') . '">' . MY_ACCOUNT_INFORMATION . '</a>'; ?> <br />
      <?php echo ' <a href="' . tep_href_link(FILENAME_ADDRESS_BOOK, '', 'SSL') . '">' . MY_ACCOUNT_ADDRESS_BOOK . '</a>'; ?> <br />
      <?php echo ' <a href="' . tep_href_link(FILENAME_ACCOUNT_PASSWORD, '', 'SSL') . '">' . MY_ACCOUNT_PASSWORD . '</a>'; ?> <br />
            <?php echo ' <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '?subject= ' . EMAIL_ACCOUNT_DELETE . '&body= ' . EMAIL_ACCOUNT_DELETE_BODY . '">' . MY_ACCOUNT_DELETE . '</a>'; ?> <br />
    </div><br />
  <h2 class="b">
  <?php //echo tep_image_2ma(bts_select(images, 'account_orders.png')); ?>
  <?php echo MY_ORDERS_TITLE; ?></h2>
    <div class="InfoBoxContenent2MA">
      <?php echo ' <a href="' . tep_href_link(FILENAME_ACCOUNT_HISTORY, '', 'SSL') . '">' . MY_ORDERS_VIEW . '</a>'; ?>
    </div><br />
  <h2 class="b">
  <?php //echo tep_image_2ma(bts_select(images, 'account_notifications.png')); ?>
  <?php echo EMAIL_NOTIFICATIONS_TITLE; ?></h2>
  <div class="InfoBoxContenent2MA">
      <?php echo ' <a href="' . tep_href_link(FILENAME_ACCOUNT_NEWSLETTERS, '', 'SSL') . '">' . EMAIL_NOTIFICATIONS_NEWSLETTERS . '</a>'; ?> <br />
      <?php echo ' <a href="' . tep_href_link(FILENAME_ACCOUNT_NOTIFICATIONS, '', 'SSL') . '">' . EMAIL_NOTIFICATIONS_PRODUCTS . '</a>'; ?>
  </div>
...
?> <div class="InfoBoxContenent2MA">
    <?php echo ' <a href="' . tep_href_link(FILENAME_MY_POINTS, '', 'SSL') . '">' . MY_POINTS_VIEW . '</a>'; ?> <br />
    <?php echo ' <a href="' . tep_href_link(FILENAME_MY_POINTS_HELP, '', 'SSL') . '">' . MY_POINTS_VIEW_HELP . '</a>'; ?>
   </div>
<?php 
