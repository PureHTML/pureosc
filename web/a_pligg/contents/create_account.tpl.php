<h1 class="pageHeading">
  ...
  <?php 
    //jsp:pwa
     if (!isset($HTTP_GET_VARS['guest']) && !isset($HTTP_POST_VARS['guest'])) echo HEADING_TITLE; else echo HEADING_TITLE_PWA; ?>
</h1> <br />

<?php 
//jsp:orig echo tep_draw_form('create_account', tep_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL'), 'post', 'onsubmit="return check_form(create_account);"') . tep_draw_hidden_field('action', 'process'); 
//jsp:pwa
//orig2: echo tep_draw_form('create_account', tep_href_link(FILENAME_CREATE_, (isset($HTTP_GET_VARS['guest'])? 'guest=guest':''), 'SSL'), 'post', 'onSubmit="return check_form(create_account);"') . tep_draw_hidden_field('action', 'process');
//orig3: if (isset($HTTP_GET_VARS['guest'])) echo tep_draw_form('create_account', tep_href_link('create_account.php?guest=guest'), 'post', 'onSubmit="return check_form(create_account);"') . tep_draw_hidden_field('action', 'process');
if (isset($HTTP_GET_VARS['guest'])) echo '<form name="create_account" action="create_account.php?guest=guest" method="post" onSubmit="return check_form(create_account);">' . tep_draw_hidden_field('action', 'process');
//orig: else echo tep_draw_form('create_account', tep_href_link('create_account.php'), 'post', 'onSubmit="return check_form(create_account);"') . tep_draw_hidden_field('action', 'process');
 else echo '<form name="create_account" action="create_account.php" method="post" onSubmit="return check_form(create_account);">' . tep_draw_hidden_field('action', 'process');
