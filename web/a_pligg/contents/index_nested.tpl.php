  ...
  $number_of_categories = tep_db_num_rows($categories_query);
    ...
    while ($categories = tep_db_fetch_array($categories_query)) {
      ...
      $width = (int)(100 / MAX_DISPLAY_CATEGORIES_PER_ROW) . '%';
            echo '<span class="TrentaTre"><a style="text-decoration:none" href="' . tep_href_link(FILENAME_DEFAULT, $cPath_new) . '"><img src="' . DIR_WS_IMAGES  .  $categories['categories_image'] . '" width="' . SUBCATEGORY_IMAGE_WIDTH . '"><br />' . $categories['categories_name'] . '</a></span>' . "\n";
