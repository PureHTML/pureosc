...
<div class="AlignLeft">
  ...
  <?php echo TEXT_CHOOSE_SHIPPING_DESTINATION . '<br /><br /><a class="n" href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '">' . tep_image_button('button_change_address.png', IMAGE_BUTTON_CHANGE_ADDRESS) . '</a> <br />'; ?>
...
?>
                    <span class="b"><?php echo $quotes[$i]['module']; ?>&nbsp;</span><?php if (isset($quotes[$i]['icon']) && tep_not_null($quotes[$i]['icon'])) { echo $quotes[$i]['icon']; } ?> 
<?php
