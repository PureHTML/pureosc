...
<?php
  ...
  $boxContent = '<table border="0" width="100%" cellspacing="0" cellpadding="0">';
    ...
    $boxContent .= '<tr><td><div align="center"><a class="n" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $best_sellers['products_id']) . '"><img src="images/'.$best_sellers['products_image'].'"></a><br><a class="n" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $best_sellers['products_id']) . '">' . $best_sellers['products_name'] . '</a></div></td></tr>';
  }
