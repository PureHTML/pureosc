...
<?php
  ...
  $boxLink = '<a class="BoxesInfoBoxHeadingCenterBoxRight" title="hotkey: [v]" href="' . tep_href_link(FILENAME_SPECIALS) . '"><font color="#b19b6a">'. BOX_HEADING_SPECIALS . '</font></a>';
  ...
  $box_id = $box_base_name . 'Box';  // for CSS styling paulm (editted BTSv1.2)
    ...
    $boxContent = '<a accesskey="V" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product["products_id"]) . '">'. '<span class="ie6balengo">' . tep_image(DIR_WS_IMAGES . $random_product['products_image'], $random_product['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) .'</span>'. $random_product['products_name'] . '</a><br />
