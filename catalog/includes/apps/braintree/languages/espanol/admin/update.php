...
error_saving_download = Could not download the update package to the following location. Please delete the file if it exists and try again.
<br/><br/>:filepath
error_download_directory_permissions = The required permissions on the following directory is not correctly set. Please update the permissions to allow write access.
<br/><br/>:filepath
