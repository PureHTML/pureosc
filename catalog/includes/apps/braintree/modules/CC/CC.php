...
class CC
{
    ...
    public function __construct()
    {
        ...
        if (version_compare(\PHP_VERSION, '5.4.0', '<')) {
            $this->_req_notes[] = $OSCOM_Braintree->getDef('module_cc_error_php', ['version' => '5.4.0']);
        }
        ...
        if (!empty($exts)) {
            $this->_req_notes[] = $OSCOM_Braintree->getDef('module_cc_error_php_ext', ['ext' => implode('<br />', $exts)]);
        }
        ...
        if (\defined('OSCOM_APP_PAYPAL_BRAINTREE_CC_STATUS')) {
            ...
            if (isset($ma)) {
                ...
                if ($ma_error === true) {
                    $this->_req_notes[] = $OSCOM_Braintree->getDef('module_cc_error_merchant_accounts_currency', ['currency' => DEFAULT_CURRENCY]);
                }
            }
        }
    }
    ...
    public function install($OSCOM_Braintree): void
    {
    ...
    public function uninstall($OSCOM_Braintree): void
    {
        $installed = explode(';', MODULE_PAYMENT_INSTALLED);
