...
class OSCOM_Braintree
{
    ...
    public function installCheck(): void
    {
        if (!\defined('OSCOM_APP_PAYPAL_BRAINTREE_CC_SORT_ORDER')) {
            ...
            $installed_pos = array_search('braintree_cc.php', $installed, true);
...
EOD;
        ...
        if (!\defined('MODULE_CONTENT_ACCOUNT_BRAINTREE_CARDS_SORT_ORDER')) {
            ...
            $pos = array_search('account/cm_account_braintree_cards', $cm, true);
    ...
    public function getModules()
    {
        ...
        if (!isset($result)) {
            ...
            if ($dir = @dir(DIR_FS_CATALOG.'includes/apps/braintree/modules/')) {
                while ($file = $dir->read()) {
                    if (!\in_array($file, ['.', '..'], true) && is_dir(DIR_FS_CATALOG.'includes/apps/braintree/modules/'.$file) && file_exists(DIR_FS_CATALOG.'includes/apps/braintree/modules/'.$file.'/'.$file.'.php')) {
    ...
    public function hasApiCredentials($server)
    {
        ...
        $creds = ['OSCOM_APP_PAYPAL_BRAINTREE_'.$server.'MERCHANT_ID',
    ...
    public function getApiCredentials($server, $type)
    {
        ...
        if (\defined('OSCOM_APP_PAYPAL_BRAINTREE_SANDBOX_API_'.strtoupper($type))) {
    ...
    public function setupCredentials($server = null): void
    {
