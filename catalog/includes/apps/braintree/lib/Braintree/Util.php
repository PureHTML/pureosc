...
class Util
{
     ...
     */
    public static function throwStatusCodeException($statusCode, $message = null): void
    {
        switch ($statusCode) {
            case 401:
     ...
     * @throws Exception multiple types depending on the error
     */
    public static function throwGraphQLResponseException($response): void
    {
        ...
        foreach ($errors as $error) {
            ...
            if ($errorClass === 'UNSUPPORTED_CLIENT') {
                throw new Exception\UpgradeRequired();
            }

            if ($errorClass === 'RESOURCE_LIMIT') {
                throw new Exception\TooManyRequests();
            }
            ...
            if ($errorClass === 'SERVICE_AVAILABILITY') {
     ...
     */
    public static function verifyKeys($signature, $attributes): void
    {
