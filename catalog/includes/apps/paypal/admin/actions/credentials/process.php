...
if ($current_module === 'PP') {
    $data = ['OSCOM_APP_PAYPAL_LIVE_SELLER_EMAIL' => isset($_POST['live_email']) ? tep_db_prepare_input($_POST['live_email']) : '',
    ...
    $data = ['OSCOM_APP_PAYPAL_PF_LIVE_PARTNER' => isset($_POST['live_partner']) ? tep_db_prepare_input($_POST['live_partner']) : '',
