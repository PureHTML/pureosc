...
define('HEADING_TITLE', 'Información sobre Mi Cuenta');

define('OVERVIEW_TITLE', 'Vision General');
...
define('MY_ACCOUNT_INFORMATION', 'Ver o cambiar la información de mi cuenta.');
define('MY_ACCOUNT_ADDRESS_BOOK', 'Ver o cambiar las entradas en mi libreta de direcciones.');
define('MY_ACCOUNT_PASSWORD', 'Cambiar la contraseña de mi Cuenta.');
