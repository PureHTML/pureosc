...
\define('MODULE_PAYMENT_SAGE_PAY_FORM_TEXT_PUBLIC_TITLE', 'Tarjeta de cr&eacute;dito o tarjeta bancaria (Procesado por Sage Pay)');
...
\define('MODULE_PAYMENT_SAGE_PAY_FORM_ERROR_TITLE', 'Se ha producido un error al procesar su transacci&oacute;n del pedido');
\define('MODULE_PAYMENT_SAGE_PAY_FORM_ERROR_GENERAL', 'Por favor, int&eacute;ntelo de nuevo y si el problema persiste, pruebe otro m&eacute;todo de pago.');
