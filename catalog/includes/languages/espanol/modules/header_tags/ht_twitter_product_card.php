...
*/
  ...
  define('MODULE_HEADER_TAGS_TWITTER_PRODUCT_CARD_TITLE', 'Tarjeta Twitter');
  define('MODULE_HEADER_TAGS_TWITTER_PRODUCT_CARD_DESCRIPTION', 'Añadir etiquetas Tarjeta Twitter a sus páginas de producto.');
