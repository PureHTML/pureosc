...
define('BOX_INFORMATION', 'Jsme ověřit SSL Session ID automaticky generované vaším prohlížečem na každém bezpečném požadavku na stránku li se na tento server.
