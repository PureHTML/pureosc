...
\define(
    ...
    'Seznam oznámení výrobek vám umožní zůstat až do dnešního dne produktech najdete zajímavé .<br /><br />Chcete-li být až do dnešního dne všechny změny produktu , zvolte <strong>Global Product Oznámení</strong>.',
);
