...
\define('MODULE_PAYMENT_INPAY_TEXT_PUBLIC_HTML', <<<'EOD'
<img src="https://resources.inpay.com/images/oscommerce/inpay_checkout.png" alt="Secure checkouts using inpay" /><br /><br />
  <table cellspacing="5">
...
EOD);
\define('MODULE_PAYMENT_INPAY_TEXT_DESCRIPTION', <<<'EOD'
<strong>What is inpay?</strong><br />
