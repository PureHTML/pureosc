...
define('MY_NOTIFICATIONS_DESCRIPTION', 'The product notification list allows you to stay up to date on products you find of interest.<br />To be up to date on all product changes, select <strong>Global Product Notifications</strong>.');
...
define('NOTIFICATIONS_NON_EXISTING', 'There are currently no products marked to be notified on.<br />To add products to your product notification list, click on the notification link available on the detailed product information page.');
