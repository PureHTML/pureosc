...
class authorizenet_cc_aim
{
    ...
    public function update_status(): void
    {
        ...
        if (($this->enabled === true) && ((int) MODULE_PAYMENT_AUTHORIZENET_CC_AIM_ZONE > 0)) {
            $check_flag = false;
            $check_query = tep_db_query("select zone_id from zones_to_geo_zones where geo_zone_id = '".MODULE_PAYMENT_AUTHORIZENET_CC_AIM_ZONE."' and zone_country_id = '".(int) $order->billing['country']['id']."' order by zone_id");
    ...
    public function confirmation()
    {
        ...
        for ($i = 1; $i < 13; ++$i) {
            $expires_month[] = ['id' => sprintf('%02d', $i), 'text' => sprintf('%02d', $i)];
        }
        ...
        $confirmation = ['fields' => [['title' => MODULE_PAYMENT_AUTHORIZENET_CC_AIM_CREDIT_CARD_OWNER_FIRSTNAME,
            'field' => tep_draw_input_field('cc_owner_firstname', $order->billing['firstname'])],
            ['title' => MODULE_PAYMENT_AUTHORIZENET_CC_AIM_CREDIT_CARD_OWNER_LASTNAME,
                'field' => tep_draw_input_field('cc_owner_lastname', $order->billing['lastname'])],
            ['title' => MODULE_PAYMENT_AUTHORIZENET_CC_AIM_CREDIT_CARD_NUMBER,
                'field' => tep_draw_input_field('cc_number_nh-dns')],
            ['title' => MODULE_PAYMENT_AUTHORIZENET_CC_AIM_CREDIT_CARD_EXPIRES,
                'field' => tep_draw_pull_down_menu('cc_expires_month', $expires_month).'&nbsp;'.tep_draw_pull_down_menu('cc_expires_year', $expires_year)],
            ['title' => MODULE_PAYMENT_AUTHORIZENET_CC_AIM_CREDIT_CARD_CCV,
    ...
    public function before_process(): void
    {
        ...
        $params = ['x_login' => substr(MODULE_PAYMENT_AUTHORIZENET_CC_AIM_LOGIN_ID, 0, 20),
    ...
    public function get_error()
    {
        ...
        $error = ['title' => MODULE_PAYMENT_AUTHORIZENET_CC_AIM_ERROR_TITLE,
            'error' => $error_message];
    ...
    public function getParams()
    {
        ...
        return ['MODULE_PAYMENT_AUTHORIZENET_CC_AIM_STATUS' => ['title' => 'Enable Authorize.net Advanced Integration Method',
            'desc' => 'Do you want to accept Authorize.net Advanced Integration Method payments?',
            'value' => 'True',
            'set_func' => 'tep_cfg_select_option(array(\'True\', \'False\'), '],
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_LOGIN_ID' => ['title' => 'API Login ID',
                'desc' => 'The API Login ID used for the Authorize.net service'],
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_TRANSACTION_KEY' => ['title' => 'API Transaction Key',
                'desc' => 'The API Transaction Key used for the Authorize.net service'],
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_MD5_HASH' => ['title' => 'MD5 Hash',
                'desc' => 'The MD5 Hash value to verify transactions with'],
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_TRANSACTION_METHOD' => ['title' => 'Transaction Method',
                'desc' => 'The processing method to use for each transaction.',
                'value' => 'Authorization',
                'set_func' => 'tep_cfg_select_option(array(\'Authorization\', \'Capture\'), '],
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_ORDER_STATUS_ID' => ['title' => 'Set Order Status',
                'desc' => 'Set the status of orders made with this payment module to this value',
                'value' => '0',
                'use_func' => 'tep_get_order_status_name',
                'set_func' => 'tep_cfg_pull_down_order_statuses('],
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_REVIEW_ORDER_STATUS_ID' => ['title' => 'Review Order Status',
                'desc' => 'Set the status of orders flagged as being under review to this value',
                'value' => '0',
                'use_func' => 'tep_get_order_status_name',
                'set_func' => 'tep_cfg_pull_down_order_statuses('],
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_TRANSACTION_ORDER_STATUS_ID' => ['title' => 'Transaction Order Status',
                'desc' => 'Include transaction information in this order status level',
                'value' => $status_id,
                'use_func' => 'tep_get_order_status_name',
                'set_func' => 'tep_cfg_pull_down_order_statuses('],
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_ZONE' => ['title' => 'Payment Zone',
                'desc' => 'If a zone is selected, only enable this payment method for that zone.',
                'value' => '0',
                'set_func' => 'tep_cfg_pull_down_zone_classes(',
                'use_func' => 'tep_get_zone_class_title'],
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_TRANSACTION_SERVER' => ['title' => 'Transaction Server',
            ...
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_TRANSACTION_MODE' => ['title' => 'Transaction Mode',
                'desc' => 'Transaction mode used for processing orders',
                'value' => 'Live',
                'set_func' => 'tep_cfg_select_option(array(\'Live\', \'Test\'), '],
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_VERIFY_SSL' => ['title' => 'Verify SSL Certificate',
                'desc' => 'Verify transaction server SSL certificate on connection?',
                'value' => 'True',
                'set_func' => 'tep_cfg_select_option(array(\'True\', \'False\'), '],
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_PROXY' => ['title' => 'Proxy Server',
                'desc' => 'Send API requests through this proxy server. (host:port, eg: 123.45.67.89:8080 or proxy.example.com:8080)'],
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_DEBUG_EMAIL' => ['title' => 'Debug E-Mail Address',
                'desc' => 'All parameters of an invalid transaction will be sent to this email address.'],
            'MODULE_PAYMENT_AUTHORIZENET_CC_AIM_SORT_ORDER' => ['title' => 'Sort order of display.',
