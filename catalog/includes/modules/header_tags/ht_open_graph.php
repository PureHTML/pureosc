...
class ht_open_graph
{
    ...
    public function isEnabled()
    {
        ...
        if (\in_array($PHP_SELF, ['index.php', 'manufacturers.php', 'product_info.php'], true)) {
            return $this->enabled;
        }
    ...
    {
        return ['MODULE_HEADER_TAGS_OPEN_GRAPH_STATUS', 'MODULE_HEADER_TAGS_OPEN_GRAPH_APP_ID', 'MODULE_HEADER_TAGS_OPEN_GRAPH_SORT_ORDER'];
    }
