...
<div class="mb-3">
  ...
  <?php echo tep_draw_input_field('lastname', $entry['entry_lastname'] ?? '', 'id="lastname" class="form-control"'); ?>
</div>
...
if (ACCOUNT_COMPANY === 'true') {
  ...
  <div class="mb-3">
    ...
    <?php echo tep_draw_input_field('company', $entry['entry_company'] ?? '', 'id="company" class="form-control"'); ?>
  </div>
...
<div class="mb-3">
  ...
  <?php echo tep_draw_input_field('street_address', $entry['entry_street_address'] ?? '', 'id="street-address" class="form-control"'); ?>
</div>
...
if (ACCOUNT_SUBURB === 'true') {
  ...
  <div class="mb-3">
    ...
    <?php echo tep_draw_input_field('suburb', $entry['entry_suburb'] ?? '', 'id="suburb" class="form-control"'); ?>
  </div>
...
<div class="mb-3">
  ...
  <?php echo tep_draw_input_field('postcode', $entry['entry_postcode'] ?? '', 'id="postcode" class="form-control"'); ?>
</div>
<div class="mb-3">
  ...
  <?php echo tep_draw_input_field('city', $entry['entry_city'] ?? '', 'id="city" class="form-control"'); ?>
</div>
...
<div class="mb-3">
  ...
  <?php echo tep_get_country_list('country', $entry['entry_country_id'] ?? STORE_COUNTRY, 'id="country" class="form-select"'); ?>
</div>
