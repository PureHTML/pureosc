...
class cm_index_product_listing
{
    ...
    {
        return ['MODULE_CONTENT_INDEX_PRODUCT_LISTING_STATUS', 'MODULE_CONTENT_INDEX_PRODUCT_LISTING_PRODUCTS_SUBCATEGORIES', 'MODULE_CONTENT_INDEX_PRODUCT_LISTING_SORT_ORDER'];
    }
}
