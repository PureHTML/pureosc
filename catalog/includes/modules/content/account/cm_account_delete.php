...
class cm_account_delete
{
    ...
    public function __construct()
    {
        ...
        $this->title = MODULE_CONTENT_ACCOUNT_DELETE_TITLE;
        $this->description = MODULE_CONTENT_ACCOUNT_DELETE_DESCRIPTION;

        if ($this->check()) {
            $this->sort_order = MODULE_CONTENT_ACCOUNT_DELETE_SORT_ORDER;
            $this->enabled = (MODULE_CONTENT_ACCOUNT_DELETE_STATUS === 'True');
        }
    }
    ...
    public function execute(): void
    {
        ...
        $oscTemplate->_data[$this->group]['privacy_settings']['links']['delete_account'] = ['title' => MODULE_CONTENT_ACCOUNT_DELETE_LINK_TITLE,
    ...
    {
        return \defined('MODULE_CONTENT_ACCOUNT_DELETE_STATUS');
    }
    ...
    {
        return ['MODULE_CONTENT_ACCOUNT_DELETE_STATUS', 'MODULE_CONTENT_ACCOUNT_DELETE_SORT_ORDER'];
    }
}
