...
class cm_account_cookie_consent
{
    ...
    public function execute(): void
    {
        ...
        $oscTemplate->_data[$this->group]['privacy_settings']['links']['cookie_consent'] = ['title' => MODULE_CONTENT_ACCOUNT_COOKIE_CONSENT_LINK_TITLE,
    ...
    {
        return ['MODULE_CONTENT_ACCOUNT_COOKIE_CONSENT_STATUS', 'MODULE_CONTENT_ACCOUNT_COOKIE_CONSENT_SORT_ORDER'];
    }
}
