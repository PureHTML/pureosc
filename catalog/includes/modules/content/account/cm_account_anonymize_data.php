...
class cm_account_anonymize_data {
  ...
  public function execute() {
    ...
    $oscTemplate->_data[$this->group]['privacy_settings']['links']['anonymize_data'] = array('title' => MODULE_CONTENT_ACCOUNT_ANONYMIZE_DATA_LINK_TITLE,
  ...
  public function keys() {
    return array('MODULE_CONTENT_ACCOUNT_ANONYMIZE_DATA_STATUS', 'MODULE_CONTENT_ACCOUNT_ANONYMIZE_DATA_SORT_ORDER');
  }
}
