...
class cm_pi_description
{
    ...
    {
        return ['MODULE_CONTENT_PRODUCT_INFO_DESCRIPTION_STATUS', 'MODULE_CONTENT_PRODUCT_INFO_DESCRIPTION_BLOCK_PLACEMENT', 'MODULE_CONTENT_PRODUCT_INFO_DESCRIPTION_SORT_ORDER'];
    }
}
