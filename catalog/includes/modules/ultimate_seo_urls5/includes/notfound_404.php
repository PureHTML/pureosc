...
$text = ['title' => 'Page not found',
    'text' => 'The page you were looking for could not be found. Please click the below link to return to '.STORE_NAME.<<<'EOD'

                            <p><a href="
EOD.tep_href_link(FILENAME_DEFAULT).'" title="'.STORE_NAME.'">'.STORE_NAME.'</a></p><br />'];
