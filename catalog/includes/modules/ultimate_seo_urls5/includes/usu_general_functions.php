 ...
 * @param mixed $search_engine_safe
 */
...
function osc_href_link($page = '', $parameters = '', $connection = 'NONSSL', $add_session_id = true, $search_engine_safe = true)
{
    ...
    if (!tep_not_null($page)) {
        exit('</td></tr></table></td></tr></table><br><br><font color="#ff0000"><b>Error!</b></font><br><br><b>Unable to determine the page link!<br><br>');
    }
    ...
    if ($connection === 'NONSSL') {
        ...
        exit('</td></tr></table></td></tr></table><br><br><font color="#ff0000"><b>Error!</b></font><br><br><b>Unable to determine connection method on a link!<br><br>Known methods: NONSSL SSL</b><br><br>');
    }
 ...
 */
function usu_say($output, $exit = false, $file = false, $line = false, $function = 'print_r'): void
{
    $additional = '';
...
function usu5_show_vars($vars): void
{
    ?>
<div style="padding: 3em; font-family: verdana; width: 750px; margin-left: auto; margin-right: auto; clear: both;">
