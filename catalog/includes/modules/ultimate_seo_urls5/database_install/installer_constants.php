 ...
 * @var array $usu51
 */
$usu51 = ['USU5_RESET_CACHE', 'USU5_ENABLED', 'USU5_CACHE_ON', 'USU5_URLS_TYPE',
 ...
 * @var array $usu5
 */
$usu5 = ['SEO_URLS_RESET_CACHE', 'SEO_URLS_ENABLED', 'SEO_URLS_TYPE', 'SEO_URLS_CHAR_CONVERT_SET',
 ...
 * @var array $usu5
 */
$seo_urls2 = ['SEO_ENABLED', 'SEO_ADD_CID_TO_PRODUCT_URLS', 'SEO_ADD_CPATH_TO_PRODUCT_URLS', 'SEO_ADD_CAT_PARENT',
    ...
    'SEO_REMOVE_ALL_SPEC_CHARS', 'SEO_URLS_CACHE_RESET', 'SEO_URLS_UNINSTALL', 'SEO_URLS_DB_UNINSTALL'];
/**
 * Array of USU5 PRO configuration group keys and values.
 *
 * @var array $usu5_config_group
 */
$usu5_config_group = ['configuration_group_id' => '\'[--config_group_id--]\'',
...
if (!class_exists('SQLiteDatabase')) {
    ...
    $standard_cache_strategy = 'sqlite';
}
 ...
 */
$usu5_config = [['configuration_title' => '\'Enable SEO URLs 5?\'',
    ...
    ['configuration_title' => '\'Enable the cache?\'',
        ...
        'date_added' => '\''.date('Y-m-d H:i:s').'\'',
        'set_function' => '\'tep_cfg_select_option(array(\\\'true\\\', \\\'false\\\'), \''],
    ['configuration_title' => '\'Enable multi language support?\'',
        ...
        'date_added' => '\''.date('Y-m-d H:i:s').'\'',
        'set_function' => '\'tep_cfg_select_option(array(\\\'true\\\', \\\'false\\\'), \''],
    ['configuration_title' => '\'Output W3C valid URLs?\'',
        ...
        'date_added' => '\''.date('Y-m-d H:i:s').'\'',
        'set_function' => '\'tep_cfg_select_option(array(\\\'true\\\', \\\'false\\\'), \''],
    ['configuration_title' => '\'Select your chosen cache system?\'',
        ...
        'last_modified' => '\''.date('Y-m-d H:i:s').'\'',
        'date_added' => '\''.date('Y-m-d H:i:s').'\'',
        'set_function' => '\'tep_cfg_select_option(array(\\\'mysql\\\', \\\'file\\\',\\\'sqlite\\\',\\\'memcache\\\'), \''],
    ['configuration_title' => '\'Set the number of days to store the cache.\'',
        ...
        'last_modified' => '\''.date('Y-m-d H:i:s').'\'',
        'date_added' => '\''.date('Y-m-d H:i:s').'\''],
    ['configuration_title' => '\'Choose the uri format\'',
    ...
    ['configuration_title' => '\'Choose how your product link text is made up\'',
        ...
        'last_modified' => '\''.date('Y-m-d H:i:s').'\'',
        'date_added' => '\''.date('Y-m-d H:i:s').'\''],
    ['configuration_title' => '\'Filter Short Words\'',
    ...
    ['configuration_title' => '\'Add category parent to beginning of category uris?\'',
        ...
        'date_added' => '\''.date('Y-m-d H:i:s').'\'',
        'set_function' => '\'tep_cfg_select_option(array(\\\'true\\\', \\\'false\\\'), \''],
    ['configuration_title' => '\'Remove all non-alphanumeric characters?\'',
        ...
        'date_added' => '\''.date('Y-m-d H:i:s').'\'',
        'set_function' => '\'tep_cfg_select_option(array(\\\'true\\\', \\\'false\\\'), \''],
    ['configuration_title' => '\'Add cPath to product URLs?\'',
        ...
        'date_added' => '\''.date('Y-m-d H:i:s').'\'',
        'set_function' => '\'tep_cfg_select_option(array(\\\'true\\\', \\\'false\\\'), \''],
    ['configuration_title' => '\'Enter special character conversions. <b>(Better to use the file based character conversions)</b>\'',
        ...
        'last_modified' => '\''.date('Y-m-d H:i:s').'\'',
        'date_added' => '\''.date('Y-m-d H:i:s').'\''],
    ['configuration_title' => '\'Turn performance reporting on true/false.\'',
        ...
        'date_added' => '\''.date('Y-m-d H:i:s').'\'',
        'set_function' => '\'tep_cfg_select_option(array(\\\'true\\\', \\\'false\\\'), \''],
    ['configuration_title' => '\'Turn variable reporting on true/false.\'',
        ...
        'date_added' => '\''.date('Y-m-d H:i:s').'\'',
        'set_function' => '\'tep_cfg_select_option(array(\\\'true\\\', \\\'false\\\'), \''],
    ['configuration_title' => '\'Force www.mysite.com/ when www.mysite.com/index.php\'',
        ...
        'date_added' => '\''.date('Y-m-d H:i:s').'\'',
        'set_function' => '\'tep_cfg_select_option(array(\\\'true\\\', \\\'false\\\'), \''],
    ['configuration_title' => '\'Reset USU5 Cache\'',
