...
/**
 * Page module for newsdesk reviews info.
 */
class newsdesk_reviews_info extends aPage_Modules
{
    /**
     ...
     */
    protected array $dependencies = ['reviews_id' => ['marker' => '-nri-',
        ...
        'to_replace' => [':TABLE_NEWSDESK_DESCRIPTION', ':reviews_id', ':languages_id']]];
     ...
     */
    protected array $cache_name_builder = ['reviews_id' => 1]; // xxx = _GET key ( e.g. cPath ), you may want to add "page" if there are paging functions
     ...
     *
     * @return Newsdesk_Reviews_Info_Page_Module
     */
    ...
    public function buildLink($page, $parameters, $add_session_id, $connection)
    {
        ...
        switch (true) {
            case $this->key === 'reviews_id': // xxx = _GET key ( e.g. cPath )
