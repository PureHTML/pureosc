...
/**
 * Page module for product reviews.
 */
class product_reviews extends aPage_Modules
{
    /**
     ...
     */
    protected array $dependencies = ['products_id' => ['marker' => '-pr-',
     ...
     */
    protected array $cache_name_builder = ['products_id' => 1]; // xxx = _GET key ( e.g. cPath ), you may want to add "page" if there are paging functions
     ...
     *
     * @return Product_Reviews_Page_Module
     */
    ...
    public function buildLink($page, $parameters, $add_session_id, $connection)
    {
        ...
        switch (true) {
            case $this->key === 'products_id': // xxx = _GET key ( e.g. cPath )
                ...
                $this->setQuery([TABLE_PRODUCTS_DESCRIPTION, TABLE_PRODUCTS, $this->stripPathToLastNumber($this->keys_index[$this->key]), Usu_Main::i()->getVar('languages_id')]);
