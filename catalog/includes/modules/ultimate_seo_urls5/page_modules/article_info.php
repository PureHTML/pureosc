...
/**
 * articles contribution article_info.php.
 */
class article_info extends aPage_Modules
{
    /**
     ...
     */
    protected array $dependencies = ['articles_id' => ['marker' => '-a-',
        ...
        'to_replace' => [':TABLE_ARTICLES_DESCRIPTION', ':articles_id', ':languages_id']]];
     ...
     */
    protected array $cache_name_builder = ['articles_id' => 1]; // xxx = _GET key ( e.g. cPath ), you may want to add "page" if there are paging functions
    ...
    {
        if (!self::$_singleton instanceof Article_Info_Page_Module) {
