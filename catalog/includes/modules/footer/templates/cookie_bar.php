<div class="alert alert-light mh-100 overflow-auto fixed-bottom m-0 rounded-0 border shadow-lg fade show">
  ...
  <div class="container">
    ...
    <p class="text-center">
      <?php echo tep_draw_button(MODULE_FOOTER_COOKIE_BAR_TEXT_COOKIES_SETTING, 'document', null, 'btn-link', ['params' => 'data-bs-toggle="collapse" data-cookie-groups="'.implode(', ', $cookie_groups).'" href="#cookie-bar" role="button" aria-expanded="false" aria-controls="cookie-bar"']); ?>
      <?php echo tep_draw_button(MODULE_FOOTER_COOKIE_BAR_TEXT_DISABLE_ALL, 'check', null, 'btn-primary', ['params' => 'id="cookies-disable-all" data-bs-dismiss="alert" aria-label="Close"']); ?>
      <?php echo tep_draw_button(MODULE_FOOTER_COOKIE_BAR_TEXT_ALLOW_ALL, 'check', null, 'btn-primary', ['params' => 'id="cookies-allow-all" data-bs-dismiss="alert" aria-label="Close"']); ?>
    </p>
    ...
    ?>
            ...
            <div class="text-center">
              <?php echo tep_draw_button(MODULE_FOOTER_COOKIE_BAR_TEXT_HIDE, 'close', null, '', ['params' => 'data-bs-toggle="collapse" data-bs-target="#cookie-bar" role="button" aria-expanded="false" aria-controls="cookie-bar"']); ?>
              <?php echo tep_draw_button(MODULE_FOOTER_COOKIE_BAR_TEXT_SAVE_CHANGES, 'disk', null, 'btn-primary', ['params' => 'id="cookies-save-changes" data-bs-dismiss="alert" aria-label="Close"']); ?>
            </div>
          </div>
        </div>
      </div>
