...
class order
{
    ...
    public function cart(): void
    {
        ...
        if ($this->content_type === 'virtual') {
            $tax_address = ['entry_country_id' => -1,
                'entry_zone_id' => -1];
        } else {
        ...
        $this->delivery = ['firstname' => $shipping_address['entry_firstname'],
            ...
            'country' => ['id' => $shipping_address['countries_id'], 'title' => $shipping_address['countries_name'], 'iso_code_2' => $shipping_address['countries_iso_code_2'], 'iso_code_3' => $shipping_address['countries_iso_code_3']],
