 ...
 */
    function __construct()
    {
            ...
            $this->default_config['SEO_ADD_CID_TO_PRODUCT_URLS'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Add cPath to product URLs?', 'SEO_ADD_CID_TO_PRODUCT_URLS', 'false', 'This setting will append the cPath to the end of product URLs (i.e. - some-product-p-1.html?cPath=xx).', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['SEO_ADD_CPATH_TO_PRODUCT_URLS'] = array('DEFAULT' => 'true',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Add category parent to product URLs?', 'SEO_ADD_CPATH_TO_PRODUCT_URLS', 'false', 'This setting will append the category parent(s) name to the product URLs (i.e. - parent-some-product-p-1.html).', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['SEO_ADD_CAT_PARENT'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Add category parent to begining of URLs?', 'SEO_ADD_CAT_PARENT', 'false', 'This setting will add the category parent(s) name to the beginning of the category URLs (i.e. - parent-category-c-1.html).', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['SEO_URLS_FILTER_SHORT_WORDS'] = array('DEFAULT' => '0',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Filter Short Words', 'SEO_URLS_FILTER_SHORT_WORDS', '3', 'This setting will filter words less than or equal to the value from the URL.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, NULL)");
            $x++;
            $this->default_config['SEO_URLS_USE_W3C_VALID'] = array('DEFAULT' => 'true',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Output W3C valid URLs (parameter string)?', 'SEO_URLS_USE_W3C_VALID', 'true', 'This setting will output W3C valid URLs.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['USE_SEO_CACHE_GLOBAL'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Enable SEO cache to save queries?', 'USE_SEO_CACHE_GLOBAL', 'true', 'This is a global setting and will turn off caching completely.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['USE_SEO_CACHE_PRODUCTS'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Enable product cache?', 'USE_SEO_CACHE_PRODUCTS', 'false', 'This will turn off caching for the products.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['USE_SEO_CACHE_CATEGORIES'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Enable categories cache?', 'USE_SEO_CACHE_CATEGORIES', 'false', 'This will turn off caching for the categories.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['USE_SEO_CACHE_MANUFACTURERS'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Enable manufacturers cache?', 'USE_SEO_CACHE_MANUFACTURERS', 'true', 'This will turn off caching for the manufacturers.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['USE_SEO_CACHE_ARTICLES'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Enable Articles Manager Articles cache?', 'USE_SEO_CACHE_ARTICLES', 'false', 'This will turn off caching for the Articles Manager articles.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['USE_SEO_CACHE_TOPICS'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Enable Articles Manager Topics cache?', 'USE_SEO_CACHE_TOPICS', 'false', 'This will turn off caching for the Articles Manager topics.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['USE_SEO_CACHE_FAQDESK_CATEGORIES'] = array('DEFAULT' => 'false',
            ...
            $x++;
            $this->default_config['USE_SEO_CACHE_INFO_PAGES'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Enable Information Pages cache?', 'USE_SEO_CACHE_INFO_PAGES', 'false', 'This will turn off caching for Information Pages.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['USE_SEO_CACHE_LINKS'] = array('DEFAULT' => 'false',
            ...
            $x++;
            $this->default_config['USE_SEO_CACHE_NEWSDESK_ARTICLES'] = array('DEFAULT' => 'false',
            ...
            $x++;
            $this->default_config['USE_SEO_CACHE_NEWSDESK_CATEGORIES'] = array('DEFAULT' => 'false',
            ...
            $x++;
            $this->default_config['USE_SEO_CACHE_POLLBOOTH'] = array('DEFAULT' => 'false',
            ...
            $x++;
            $this->default_config['USE_SEO_CACHE_PAGE_EDITOR'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Enable Page Editor cache?', 'USE_SEO_CACHE_PAGE_EDITOR', 'false', 'This will turn off caching for the Page Editor pages.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['USE_SEO_REDIRECT'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Enable automatic redirects?', 'USE_SEO_REDIRECT', 'true', 'This will activate the automatic redirect code and send 301 headers for old to new URLs.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['USE_SEO_HEADER_TAGS'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Enable use Header Tags SEO as name?', 'USE_SEO_HEADER_TAGS', 'false', 'This will cause the title set in Header Tags SEO to be used instead of the categories or products name.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['USE_SEO_PERFORMANCE_CHECK'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Enable performance checker?', 'USE_SEO_PERFORMANCE_CHECK', 'false', 'This will cause the code to track all database queries so that its affect on the speed of the page can be determined. Enabling it will cause a small speed loss.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['SEO_REWRITE_TYPE'] = array('DEFAULT' => 'Rewrite',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Choose URL Rewrite Type', 'SEO_REWRITE_TYPE', 'Rewrite', 'Choose which SEO URL format to use.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''Rewrite''),')");
            $x++;
            $this->default_config['SEO_CHAR_CONVERT_SET'] = array('DEFAULT' => '',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Enter special character conversions', 'SEO_CHAR_CONVERT_SET', '', 'This setting will convert characters.<br><br>The format <b>MUST</b> be in the form: <b>char=>conv,char2=>conv2</b>', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, NULL)");
            $x++;
            $this->default_config['SEO_REMOVE_ALL_SPEC_CHARS'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Remove all non-alphanumeric characters?', 'SEO_REMOVE_ALL_SPEC_CHARS', 'false', 'This will remove all non-letters and non-numbers.  This should be handy to remove all special characters with 1 setting.', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), NULL, 'tep_cfg_select_option(array(''true'', ''false''),')");
            $x++;
            $this->default_config['SEO_URLS_CACHE_RESET'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Reset SEO URLs Cache', 'SEO_URLS_CACHE_RESET', 'false', 'This will reset the cache data for SEO', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), 'tep_reset_cache_data_seo_urls', 'tep_cfg_select_option(array(''reset'', ''false''),')");
            $x++;
            $this->default_config['SEO_URLS_UNINSTALL'] = array('DEFAULT' => 'false',
                                  'QUERY' => "INSERT INTO `configuration` VALUES ('', 'Uninstall Ultimate SEO', 'SEO_URLS_DB_UNINSTALL', 'false', 'This will delete all of the entries in the configuration table for SEO', GROUP_INSERT_ID, " . $x . ", NOW(), NOW(), 'tep_reset_cache_data_seo_urls', 'tep_cfg_select_option(array(''uninstall'', ''false''),')");
            $this->init();
...
//ojp FILENAME_LINKS
            ...
            if (file_exists('allprods_seo.php')) {
                $seo_pages[] = 'allprods_seo.php';
            }
            if (file_exists('articles.php')) {
                $seo_pages[] = 'articles.php';
            }
            if (file_exists('article_info.php')) {
                $seo_pages[] = 'article_info.php';
            }
            if (file_exists('article_blog.php')) {
                $seo_pages[] = 'article_blog.php';
            }
            if (file_exists('information.php')) {
                $seo_pages[] = 'information.php';
            }
            if (file_exists('pollbooth.php')) {
                $seo_pages[] = 'pollbooth.php';
            }
            if (file_exists('faqdesk_info.php')) {
                $seo_pages[] = 'faqdesk_info.php';
            }
            if (file_exists('faqdesk_index.php')) {
                $seo_pages[] = 'faqdesk_index.php';
            }
            if (file_exists('faqdesk_reviews_info.php')) {
                $seo_pages[] = 'faqdesk_reviews_info.php';
            }
            if (file_exists('faqdesk_reviews_article.php')) {
                $seo_pages[] = 'faqdesk_reviews_article.php';
            }
            if (file_exists('links.php')) {
                $seo_pages[] = 'links.php';
            }
            if (file_exists('newsdesk_info.php')) {
                $seo_pages[] = 'newsdesk_info.php';
            }
            if (file_exists('newsdesk_index.php')) {
                $seo_pages[] = 'newsdesk_index.php';
            }
            if (file_exists('newsdesk_reviews_info.php')) {
                $seo_pages[] = 'newsdesk_reviews_info.php';
            }
            if (file_exists('newsdesk_reviews_article.php')) {
                $seo_pages[] = 'newsdesk_reviews_article.php';
            }
...
//ojp generate_link_cache
            ...
            if ($this->attributes['USE_SEO_CACHE_GLOBAL'] == 'true') {
                ...
                if ($this->attributes['USE_SEO_CACHE_ARTICLES'] == 'true') {
                    $this->generate_articles_cache();
                }
                if ($this->attributes['USE_SEO_CACHE_ARTICLES_AUTHORS'] == 'true') {
                    $this->generate_articles_authors_cache();
                }
                if ($this->attributes['USE_SEO_CACHE_FAQDESK_CATEGORIES'] == 'true' && defined('TABLE_FAQDESK')) {
                    $this->generate_faqdesk_categories_cache();
                }
                if ($this->attributes['USE_SEO_CACHE_INFO_PAGES'] == 'true') {
                    $this->generate_information_cache();
                }
                if ($this->attributes['USE_SEO_CACHE_LINKS'] == 'true' && defined('TABLE_LINK_CATEGORIES')) {
                    $this->generate_links_cache();
                }
                if ($this->attributes['USE_SEO_CACHE_NEWSDESK_ARTICLES'] == 'true' && defined('TABLE_NEWSDESK')) {
                    $this->generate_newsdesk_name_cache();
                }
                if ($this->attributes['USE_SEO_CACHE_NEWSDESK_CATEGORIES'] == 'true' && defined('TABLE_NEWSDESK')) {
                    $this->generate_newsdesk_categories_cache();
                }
                if ($this->attributes['USE_SEO_CACHE_PAGE_EDITOR'] == 'true' && defined('TABLE_PAGES')) {
                    $this->generate_page_editor_cache();
                }
                if ($this->attributes['USE_SEO_CACHE_POLLBOOTH'] == 'true' && defined('TABLE_POLLBOOTH')) {
                    $this->generate_pollbooth_cache();
                }
                if ($this->attributes['USE_SEO_CACHE_TOPICS'] == 'true') {
        ...
        switch (true) {
            ...
            default:
                ...
                if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true') {
                    ...
                    $return = (tep_not_null($cName) ? $cName . 'xslashx' .  $pName : $pName);
                break;
        } # end switch
            return $return;
    } # end function
            ...
            default:
                if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true') {
                    ...
                    $sql = "SELECT categories_name as fcName 
                                                FROM faqdesk_categories_description 
        ...
        switch (true) {
            ...
            default:
                ...
                $sql = "SELECT link_categories_name as lName 
						FROM link_categories_description 
                ...
                if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true') {
                    $this->performance['QUERIES']['LINKS'][] = $sql;
                }
                $return = $lName;
                break;
        } # end switch
    ...
    function get_pollbooth($poID)
    {
        switch (true) {
            ...
            default:
                ...
                if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true') {
                    $this->performance['QUERIES']['POLLBOOTH'][] = $sql;
                }
                    $return = $poName;
                break;
        } # end switch
            ...
            default:
                if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true') {
                    ...
                    $sql = "SELECT categories_name as ncName 
                                                FROM newsdesk_categories_description 
    ...
    function generate_categories_cache()
    {
        ...
        if (!$is_cached || $is_expired) { // it's not cached so create it
            ...
            while ($category = $this->DB->FetchArray($category_query)) {
                    ...
                    $name = isset($category['pName']) && $this->not_null($category['pName']) ? $category['pName'] . ' ' . $category['cName'] : $category['cName'];
    ...
    function generate_articles_authors_cache()
    {
        ...
        if (!$is_cached || $is_expired) { // it's not cached so create it
                $sql = "SELECT a.authors_id as id, a.authors_name as name
       					FROM authors a LEFT JOIN authors_info ai on a.authors_id = ai.authors_id
                            ...
                            if ($actualID == 0) {
                                ...
                                if (strpos($this->attributes['SEO_REDIRECT']['URI_PARSED']['path'], '-c-' . $actualPath) !== false) { //this is the actual url
                                    if (0 == $actualID && strpos($actualID . '.html', $actualPath) !== false) { //enteed url is child of full path
                                        ...
                                        $this->is_seopage = true;
                                        if ($this->need_redirect && $this->is_seopage && $this->attributes['USE_SEO_REDIRECT'] == 'true') {
                                            header($_SERVER['SERVER_PROTOCOL'] . ' 404 npt found');
            ...
            case ($this->uri != $this->real_uri && !$this->not_null($this->path_info)):
                if (($pStart = strpos($this->uri_parsed['path'], "-p-")) !== false) {
                    if (($pStop = strpos($this->uri_parsed['path'], ".html")) !== false) {
                        ...
                        if ($this->attributes['SEO_ADD_CPATH_TO_PRODUCT_URLS'] == 'true') {
                                   $cName = $this->get_all_category_parents($pID, $cName);
                                   $cName = str_replace(" ", "-", $cName) . 'xslashx';
                        }
                ...
                } elseif (($pStart = strpos($this->uri_parsed['path'], "-c-")) !== false) {
                    if (($pStop = strpos($this->uri_parsed['path'], ".html")) !== false) {
                        $forceRedirect = $this->VerifyLink($pStop, $pStart); //remove things that shouldn't be there
