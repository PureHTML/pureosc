...
class email
{
    ...
    public function __construct($headers = '')
    {
         ...
         */
        $this->image_types = ['gif' => 'image/gif',
            'jpg' => 'image/jpeg',
            'jpeg' => 'image/jpeg',
            'jpe' => 'image/jpeg',
            'bmp' => 'image/bmp',
     ...
     */
    public function find_html_images($images_dir): void
    {
     ...
     * @param mixed $text
     */
    public function add_text($text = ''): void
    {
        $this->text = tep_convert_linefeeds(["\r\n", "\n", "\r"], $this->lf, $text);
    }
     ...
     * @param null|mixed $images_dir
     */
    public function add_html($html, $text = null, $images_dir = null): void
    {
        $this->html = tep_convert_linefeeds(["\r\n", "\n", "\r"], '<br />', $html);
        $this->html_text = tep_convert_linefeeds(["\r\n", "\n", "\r"], $this->lf, $text);
     ...
     * @param mixed $c_type
     */
    public function add_html_image($file, $name = '', $c_type = 'application/octet-stream'): void
    {
        $this->html_images[] = ['body' => $file,
            'name' => $name,
            'c_type' => $c_type,
            'cid' => md5(uniqid(time()))];
    }
     ...
     */
    public function add_attachment($file, $name = '', $c_type = 'application/octet-stream', $encoding = 'base64'): void
    {
        $this->attachments[] = ['body' => $file,
            'name' => $name,
            'c_type' => $c_type,
            'encoding' => $encoding];
    }
    ...
    public function add_html_image_part(&$obj, $value): void
    {
    ...
    public function add_attachment_part(&$obj, $value): void
    {
        $params['content_type'] = $value['c_type'];
    ...
    public function send($to_name, $to_addr, $from_name, $from_addr, $subject = '', $headers = '')
    {
        ...
        $headers = array_merge($this->headers, ['From: '.$from], $headers, $xtra_headers);
