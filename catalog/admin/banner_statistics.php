...
while ($years = tep_db_fetch_array($years_query)) {
    $years_array[] = ['id' => $years['banner_year'],
...
<?php
  switch ($type) {
      case 'yearly': break;
      case 'monthly':
          echo TITLE_YEAR.' '.tep_draw_pull_down_menu('year', $years_array, $HTTP_GET_VARS['year'] ?? date('Y'), 'onchange="this.form.submit();"').'<noscript><input type="submit" value="GO"></noscript>';

          break;

      default:
      case 'daily':
          echo TITLE_MONTH.' '.tep_draw_pull_down_menu('month', $months_array, $HTTP_GET_VARS['month'] ?? date('n'), 'onchange="this.form.submit();"').'<noscript><input type="submit" value="GO"></noscript><br />'.TITLE_YEAR.' '.tep_draw_pull_down_menu('year', $years_array, $HTTP_GET_VARS['year'] ?? date('Y'), 'onchange="this.form.submit();"').'<noscript><input type="submit" value="GO"></noscript>';
