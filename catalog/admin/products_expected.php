...
if (isset($pInfo) && \is_object($pInfo)) {
    ...
    $contents[] = ['align' => 'center', 'text' => tep_draw_button(IMAGE_EDIT, 'document', tep_href_link('categories.php', 'pID='.$pInfo->products_id.'&action=new_product'))];
    $contents[] = ['text' => '<br />'.TEXT_INFO_DATE_EXPECTED.' '.tep_date_short($pInfo->products_date_available)];
}
