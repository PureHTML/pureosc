...
\define('HTPASSWD_PERMISSIONS', <<<'EOD'
<strong>Dodatečná ochrana s htaccess / htpasswd
</strong><p>Tato instalace osCommerce Online Merchant Administration Tool není dále zajištěna pomocí htaccess / htpasswd prostředky.</p><p>Následující soubory musí být zapisovatelný webovým serverem k tomu, aby htaccess / bezpečnostní htpasswd vrstvy:</p><ul><li>
EOD.DIR_FS_ADMIN.'.htaccess</li><li>'.DIR_FS_ADMIN.'.htpasswd_oscommerce</li></ul><p>Aktualizuj tuto stránku pro potvrzení, zda byly nastaveny správná oprávnění souborů.</p>');
