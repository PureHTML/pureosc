...
\define('TEXT_NEWSLETTER_CUSTOMERS', 'Všem co chcou @-novinky');

\define('NOTICE_EMAIL_SENT_TO', 'Notice: E-mail zaslán: %s');
\define('ERROR_NO_CUSTOMER_SELECTED', 'Chyba: zákazník nevybrán.');
