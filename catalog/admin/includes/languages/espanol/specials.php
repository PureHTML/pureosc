...
\define('TEXT_SPECIALS_PRICE_TIP', '<strong>Notas:</strong><ul><li>Puede introducir un porcentaje de reducción del precio de producto, por ejemplo: <strong>20%</strong></li><li>Si por el contrario, introduce un precio de oferta debe usar el punto como separador decimal \'.\' (punto decimal), por ejemplo: <strong>49.99</strong></li><li>Deje la fecha de caducidad vacía si no quiere caducidad</li></ul>');
