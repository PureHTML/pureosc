...
while ($addresses = tep_db_fetch_array($addresses_query)) {
    ...
    ?>
        ...
        <div class="col-md-4">
          <div class="fw-bold"><?php echo tep_output_string_protected($addresses['firstname'].' '.$addresses['lastname']); ?><?php if ($addresses['address_book_id'] === $customer_default_address_id) {
